...
// Pagination range (show only 5 pages)
$range = 2;
$startPage = max(1, $page - $range);
$endPage = min($totalPages, $page + $range);

// Helper: make pdf link
function makePdfLink($path) {
    if (!$path) return "";
        ...
        <div class="card">
            ...
            <?php } else { ?>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        foreach ($invoices as $inv) {
                            ...
                            $pdfLink = makePdfLink($inv['pdf_path']);
                        ?>
                            <tr>
                                <td><?php echo $sr++; ?></td>
                                    ...
                                    <div class="actions">
                                        ...
                                        <?php if (!empty($pdfLink)) { ?>
                                            <a class="btn btn-dark small" target="_blank"
                                               href="<?php echo htmlspecialchars($pdfLink); ?>">
                                               PDF
                                            </a>
                                        <?php } ?>
                ...
                <div class="pagination">
                    ...
                    <?php if ($startPage > 1) { ?>
                        <a href="<?php echo $baseUrl . 1; ?>">1</a>
                        <?php if ($startPage > 2) { ?>
                            <a href="javascript:void(0)" style="pointer-events:none; opacity:0.6;">...</a>
                        <?php } ?>
                    <?php } ?>

                    <?php for ($i = $startPage; $i <= $endPage; $i++) { ?>
                        <a class="<?php echo ($i === $page) ? "active" : ""; ?>"
                           href="<?php echo $baseUrl . $i; ?>">
                           <?php echo $i; ?>
                        </a>
                    <?php } ?>
                    ...
                    <?php if ($endPage < $totalPages) { ?>
                        <?php if ($endPage < $totalPages - 1) { ?>
                            <a href="javascript:void(0)" style="pointer-events:none; opacity:0.6;">...</a>
                        <?php } ?>
                        <a href="<?php echo $baseUrl . $totalPages; ?>"><?php echo $totalPages; ?></a>
                    <?php } ?>
