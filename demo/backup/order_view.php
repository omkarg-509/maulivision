...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="page-title" style="font-size:16px; margin-bottom:10px;">Next Step</div>
            <div style="color:#444; line-height:1.6;">
                Invoice + PDF + WhatsApp पुढे आपण add करू.  
                या order वरून invoice generate करून WhatsApp ला send करता येईल.
            </div>
        </div>
