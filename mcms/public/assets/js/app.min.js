!function(e, t) {
    ...
    function p(e) {
        return null == e ? e + "" : "object" == typeof e || "function" == typeof e ? W[q.call(e)] || "object" : typeof e
    }
    var e = "3.6.3"
      , S = function(e, t) {
    ...
    S.extend({
        ...
        isPlainObject: function(e) {
            return !(!e || "[object Object]" !== q.call(e) || (e = I(e)) && ("function" != typeof (e = F.call(e, "constructor") && e.constructor) || B.call(e) !== U))
        },
        ...
        makeArray: function(e, t) {
            t = t || [];
            return null != e && (X(Object(e)) ? S.merge(t, "string" == typeof e ? [e] : e) : H.call(t, e)),
            t
        },
    ...
    var e = function(Y) {
        ...
        var e, h, _, o, H, f, R, W, w, l, c, x, T, n, S, p, i, r, m, k = "sizzle" + +new Date, u = Y.document, E = 0, q = 0, F = A(), B = A(), U = A(), g = A(), V = function(e, t) {
            return e === t && (c = !0),
            0
        }, $ = {}.hasOwnProperty, t = [], X = t.pop, G = t.push, C = t.push, Z = t.slice, y = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, Q = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", s = "[\\x20\\t\\r\\n\\f]", a = "(?:\\\\[\\da-fA-F]{1,6}" + s + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", K = "\\[" + s + "*(" + a + ")(?:" + s + "*([*^$|!~]?=)" + s + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + a + "))|)" + s + "*\\]", J = ":(" + a + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + K + ")*)|.*)\\)|)", ee = new RegExp(s + "+","g"), v = new RegExp("^" + s + "+|((?:^|[^\\\\])(?:\\\\.)*)" + s + "+$","g"), te = new RegExp("^" + s + "*," + s + "*"), ne = new RegExp("^" + s + "*([>+~]|" + s + ")" + s + "*"), ie = new RegExp(s + "|>"), re = new RegExp(J), oe = new RegExp("^" + a + "$"), b = {
            ID: new RegExp("^#(" + a + ")"),
            CLASS: new RegExp("^\\.(" + a + ")"),
            TAG: new RegExp("^(" + a + "|[*])"),
            ATTR: new RegExp("^" + K),
        ...
        }, se = /HTML$/i, ae = /^(?:input|select|textarea|button)$/i, le = /^h\d$/i, D = /^[^{]+\{\s*\[native \w/, ce = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ue = /[+~]/, M = new RegExp("\\\\[\\da-fA-F]{1,6}" + s + "?|\\\\([^\\r\\n\\f])","g"), de = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, he = ye(function(e) {
        ...
        try {
            C.apply(t = Z.call(u.childNodes), u.childNodes),
            ...
            S)) {
                ...
                if (h.qsa && !g[e + " "] && (!p || !p.test(e)) && (1 !== d || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    1 === d && (ie.test(e) || ne.test(e))) {
                        for ((u = ue.test(e) && ge(t.parentNode) || t) === t && h.scope || ((s = t.getAttribute("id")) ? s = s.replace(de, I) : t.setAttribute("id", s = k)),
                        o = (l = f(e)).length; o--; )
                            l[o] = (s ? "#" + s : ":scope") + " " + j(l[o]);
                        c = l.join(",")
                    }
                    try {
                        if (h.cssSupportsSelector && !CSS.supports("selector(:is(" + c + "))"))
                            throw new Error;
                        return C.apply(n, u.querySelectorAll(c)),
                        n
                    } catch (t) {
                        g(e, !0)
                    } finally {
        ...
        for (e in h = O.support = {},
        H = O.isXML = function(e) {
        ...
        x = O.setDocument = function(e) {
            ...
            S = !H(T),
            u != T && (e = T.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", z, !1) : e.attachEvent && e.attachEvent("onunload", z)),
            h.scope = N(function(e) {
                return n.appendChild(e).appendChild(T.createElement("div")),
                void 0 !== e.querySelectorAll && !e.querySelectorAll(":scope fieldset div").length
            }),
            h.cssSupportsSelector = N(function() {
            ...
            i = [],
            p = [],
            (h.qsa = D.test(T.querySelectorAll)) && (N(function(e) {
                var t;
                ...
                e.querySelectorAll("[selected]").length || p.push("\\[" + s + "*(?:value|" + Q + ")"),
            ...
            (h.matchesSelector = D.test(r = n.matches || n.webkitMatchesSelector || n.mozMatchesSelector || n.oMatchesSelector || n.msMatchesSelector)) && N(function(e) {
                h.disconnectedMatch = r.call(e, "*"),
                r.call(e, "[s!='']:x"),
                i.push("!=", J)
            }),
            h.cssSupportsSelector || p.push(":has"),
            p = p.length && new RegExp(p.join("|")),
            i = i.length && new RegExp(i.join("|")),
            e = D.test(n.compareDocumentPosition),
            m = e || D.test(n.contains) ? function(e, t) {
            ...
            V = e ? function(e, t) {
                var n;
                return e === t ? (c = !0,
                0) : !e.compareDocumentPosition - !t.compareDocumentPosition || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !h.sortDetached && t.compareDocumentPosition(e) === n ? e == T || e.ownerDocument == u && m(u, e) ? -1 : t == T || t.ownerDocument == u && m(u, t) ? 1 : l ? y(l, e) - y(l, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return c = !0,
                ...
                if (!r || !o)
                    return e == T ? -1 : t == T ? 1 : r ? -1 : o ? 1 : l ? y(l, e) - y(l, t) : 0;
                if (r === o)
                    return pe(e, t);
        ...
        O.matchesSelector = function(e, t) {
            if (x(e),
            h.matchesSelector && S && !g[t + " "] && (!i || !i.test(t)) && (!p || !p.test(t)))
                try {
                    var n = r.call(e, t);
        ...
        O.attr = function(e, t) {
            ...
            var n = _.attrHandle[t.toLowerCase()]
              , n = n && $.call(_.attrHandle, t.toLowerCase()) ? n(e, t, !S) : void 0;
        ...
        (_ = O.selectors = {
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(M, d),
                    e[3] = (e[3] || e[4] || e[5] || "").replace(M, d),
                    "~=" === e[2] && (e[3] = " " + e[3] + " "),
                    e.slice(0, 4)
                },
                CHILD: function(e) {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return b.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && re.test(n) && (t = (t = f(n, !0)) && n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                TAG: function(e) {
                    var t = e.replace(M, d).toLowerCase();
                    return "*" === e ? function() {
                        return !0
                    }
                    : function(e) {
                ...
                CHILD: function(p, e, t, m, g) {
                    ...
                    : function(e, t, n) {
                        var i, r, o, s, a, l, c = v != y ? "nextSibling" : "previousSibling", u = e.parentNode, d = b && e.nodeName.toLowerCase(), h = !n && !b, f = !1;
                        if (u) {
                            if (v) {
                                for (; c; ) {
                                    for (s = e; s = s[c]; )
                            ...
                            y && h) {
                                for (f = (a = (i = (r = (o = (s = u)[k] || (s[k] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === E && i[1]) && i[2],
                            ...
                            } else if (!1 === (f = h ? a = (i = (r = (o = (s = e)[k] || (s[k] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === E && i[1] : f))
                                for (; (s = ++a && s && s[c] || (f = a = 0,
                                l.pop())) && ((b ? s.nodeName.toLowerCase() !== d : 1 !== s.nodeType) || !++f || (h && ((r = (o = s[k] || (s[k] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [E, f]),
                                s !== e)); )
                                    ;
                ...
                PSEUDO: function(e, o) {
                    ...
                    return s[k] ? s(o) : 1 < s.length ? (t = [e, e, "", o],
                    _.setFilters.hasOwnProperty(e.toLowerCase()) ? L(function(e, t) {
            ...
            pseudos: {
                ...
                target: function(e) {
                    var t = Y.location && Y.location.hash;
        ...
        function ye(s, e, t) {
            ...
            : function(e, t, n) {
                ...
                if (n) {
                    ...
                    for (; e = e[a]; )
                        if (1 === e.nodeType || u)
                            if (r = (r = e[k] || (e[k] = {}))[e.uniqueID] || (r[e.uniqueID] = {}),
        ...
        function we(e) {
            for (var i, t, n, r = e.length, o = _.relative[e[0].type], s = o || _.relative[" "], a = o ? 1 : 0, l = ye(function(e) {
                ...
                if (t = _.relative[e[a].type])
                    ...
                    if ((t = _.filter[e[a].type].apply(null, e[a].matches))[k]) {
                            ...
                            L(function(e, t, n, i) {
                                var r, o, s, a = [], l = [], c = t.length, u = e || function(e, t, n) {
                                    for (var i = 0, r = t.length; i < r; i++)
                                        O(e, t[i], n);
                                    return n
                                }(p || "*", n.nodeType ? [n] : n, []), d = !f || !e && p ? u : _e(u, a, f, n, i), h = m ? v || (e ? f : c || g) ? [] : t : d;
                                if (m && m(d, h, n, i),
                                g)
                                    for (r = _e(h, l),
                                    g(r, [], n, i),
                                ...
                                if (e) {
                                    if (v || f) {
                                        ...
                                        for (o = h.length; o--; )
                                            (s = h[o]) && -1 < (r = v ? y(e, s) : a[o]) && (e[r] = !(t[r] = s))
                                    }
                                } else
                                    h = _e(h === t ? h.splice(c, h.length) : h),
                                    v ? v(null, t, h, i) : C.apply(t, h)
                            })
                        }(1 < a && be(u), 1 < a && j(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(v, "$1"), t, a < n && we(e.slice(a, n)), n < r && we(e = e.slice(n)), n < r && j(e))
                    }
                    u.push(t)
                }
            return be(u)
        ...
        f = O.tokenize = function(e, t) {
            ...
            l = _.preFilter; s; ) {
                ...
                s = s.slice(n.length)),
                _.filter)
                    !(i = b[o].exec(s)) || l[o] && !(i = l[o](i)) || (n = i.shift(),
                    r.push({
                        value: n,
                        type: o,
                        matches: i
            ...
            return t ? s.length : s ? O.error(e) : B(e, a).slice(0)
        }
        ,
        R = O.compile = function(e, t) {
            var n, g, v, y, b, i, r = [], o = [], s = U[e + " "];
            if (!s) {
                for (n = (t = t || f(e)).length; n--; )
                    ((s = we(t[n]))[k] ? r : o).push(s);
                (s = U(e, (y = 0 < (v = r).length,
                b = 0 < (g = o).length,
                i = function(e, t, n, i, r) {
                    var o, s, a, l = 0, c = "0", u = e && [], d = [], h = w, f = e || b && _.find.TAG("*", r), p = E += null == h ? 1 : Math.random() || .1, m = f.length;
                    for (r && (w = t == T || t || r); c !== m && null != (o = f[c]); c++) {
                        if (b && o) {
                            for (s = 0,
                            t || o.ownerDocument == T || (x(o),
                            n = !S); a = g[s++]; )
                                if (a(o, t || T, n)) {
                                    i.push(o);
                                    break
        ...
        ,
        W = O.select = function(e, t, n, i) {
            var r, o, s, a, l, c = "function" == typeof e && e, u = !i && f(e = c.selector || e);
            if (n = n || [],
            1 === u.length) {
                if (2 < (o = u[0] = u[0].slice(0)).length && "ID" === (s = o[0]).type && 9 === t.nodeType && S && _.relative[o[1].type]) {
                    if (!(t = (_.find.ID(s.matches[0].replace(M, d), t) || [])[0]))
                        return n;
                    c && (t = t.parentNode),
                    e = e.slice(o.shift().value.length)
                }
                for (r = b.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r],
                !_.relative[a = s.type]); )
                    if ((l = _.find[a]) && (i = l(s.matches[0].replace(M, d), ue.test(o[0].type) && ge(t.parentNode) || t))) {
                        if (o.splice(r, 1),
                        e = i.length && j(o))
                            break;
                        return C.apply(n, i),
        ...
        ,
        h.sortStable = k.split("").sort(V).join("") === k,
    ...
    var J, ee = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, te = ((S.fn.init = function(e, t, n) {
        if (e) {
            ...
            if (i[1]) {
                ...
                S.merge(this, S.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : T, !0)),
              ...
              , s = {
                ...
                then: function(t, n, i) {
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(r < l)) {
                                    ...
                                    y(t) ? a ? t.call(e, c(l, o, u, a), c(l, o, re, a)) : (l++,
                    ...
                    return S.Deferred(function(e) {
                        o[0][3].add(c(0, e, y(i) ? i : u, e.notifyWith)),
    ...
    S.extend({
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --S.readyWait : S.isReady) || (S.isReady = !0) !== e && 0 < --S.readyWait || ae.resolveWith(T, [S])
        }
    }),
    S.ready.then = ae.then,
    "complete" === T.readyState || "loading" !== T.readyState && !T.documentElement.doScroll ? x.setTimeout(S.ready) : (T.addEventListener("DOMContentLoaded", le),
    ...
    S.extend({
        queue: function(e, t, n) {
            var i;
            if (e)
                return i = _.get(e, t = (t || "fx") + "queue"),
                n && (!i || Array.isArray(n) ? i = _.access(e, t, S.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    S.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; a--; )
                (i = _.get(s[a], e + "queueHooks")) && i.empty && (r++,
                i.empty.add(n));
            return n(),
            o.promise(t)
        }
    ...
    function ge(e, t) {
        return "none" === (e = t || e).style.display || "" === e.style.display && E(e) && "none" === S.css(e, "display")
    }
    ...
    function be(e, t, n, i) {
        ...
        , l = a(), c = n && n[3] || (S.cssNumber[t] ? "" : "px"), u = e.nodeType && (S.cssNumber[t] || "px" !== c && +l) && ve.exec(S.css(e, t));
        if (u && u[3] !== c) {
            for (c = c || u[3],
            u = +(l /= 2) || 1; s--; )
                S.style(e, t, u + c),
    ...
    function C(e, t) {
        for (var n, i, r, o, s, a, l = [], c = 0, u = e.length; c < u; c++)
            ...
            t ? ("none" === n && (l[c] = _.get(i, "display") || null,
            l[c] || (i.style.display = "")),
            "" === i.style.display && ge(i) && (l[c] = (a = o = r = void 0,
            o = i.ownerDocument,
            s = i.nodeName,
            (a = _e[s]) || (r = o.body.appendChild(o.createElement(s)),
            a = S.css(r, "display"),
            r.parentNode.removeChild(r),
            _e[s] = a = "none" === a ? "block" : a)))) : "none" !== n && (l[c] = "none",
            _.set(i, "display", n)));
        for (c = 0; c < u; c++)
    ...
    var we = /^(?:checkbox|radio)$/i
      ...
      , D = ((o = T.createElement("input")).setAttribute("type", "radio"),
        ...
        S.event.add(e, r, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[r]) {
                    ...
                    t = o(this, r),
                    this[r](),
                    i !== (n = _.get(this, r)) || t ? _.set(this, r, !1) : n = {},
                    i !== n)
                        return e.stopImmediatePropagation(),
                        e.preventDefault(),
                        n && n.value
                } else
                    i.length && (_.set(this, r, {
                        value: S.event.trigger(S.extend(i[0], S.Event.prototype), i.slice(1), this)
                    }),
                    e.stopImmediatePropagation())
            }
        })) : void 0 === _.get(e, r) && S.event.add(e, r, s)
    }
    S.event = {
        global: {},
        add: function(t, e, n, i, r) {
            var o, s, a, l, c, u, d, h, f, p = _.get(t);
            if (v(t))
        ...
        remove: function(e, t, n, i, r) {
            var o, s, a, l, c, u, d, h, f, p, m, g = _.hasData(e) && _.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(k) || [""]).length; c--; )
                    ...
                    f) {
                        ...
                        s && !h.length && (d.teardown && !1 !== d.teardown.call(e, p, g.handle) || S.removeEvent(e, f, g.handle),
                        delete l[f])
                    } else
                        for (f in l)
        ...
        dispatch: function(e) {
            var t, n, i, r, o, s = new Array(arguments.length), a = S.event.fix(e), e = (_.get(this, "events") || Object.create(null))[a.type] || [], l = S.event.special[a.type] || {};
            for (s[0] = a,
    ...
    function Ie(e, t) {
        ...
        if (1 === t.nodeType) {
            if (_.hasData(e) && (o = _.get(e).events))
                for (r in _.remove(t, "handle events"),
                o)
                    for (n = 0,
                    i = o[r].length; n < i; n++)
    ...
    function O(n, i, r, o) {
        ...
        t || o)) {
            for (a = (s = S.map(M(e, "script"), je)).length; u < d; u++)
                l = e,
                u !== h && (l = S.clone(l, !0, !0),
                a) && S.merge(s, M(l, "script")),
                r.call(n[u], l, u);
            if (a)
                ...
                u = 0; u < a; u++)
                    l = s[u],
                    Te.test(l.type || "") && !_.access(l, "globalEval") && S.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? S._evalUrl && !l.noModule && S._evalUrl(l.src, {
    ...
    function ze(e, t, n) {
        for (var i, r = t ? S.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
            n || 1 !== i.nodeType || S.cleanData(M(i)),
            i.parentNode && (n && E(i) && Se(M(i, "script")),
    ...
    S.extend({
        ...
        clone: function(e, t, n) {
            var i, r, o, s, a, l, c, u = e.cloneNode(!0), d = E(e);
            if (!(g.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || S.isXMLDoc(e)))
                for (s = M(u),
                i = 0,
                r = (o = M(e)).length; i < r; i++)
                    a = o[i],
            ...
            if (t)
                if (n)
                    ...
                    Ie(e, u);
            return 0 < (s = M(u, "script")).length && Se(s, !d && M(e, "script")),
            u
        },
    ...
    S.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (S.cleanData(M(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return d(this, function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !Ae.test(e) && !D[(xe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = S.htmlPrefilter(e);
                    try {
                        for (; n < i; n++)
                            1 === (t = this[n] || {}).nodeType && (S.cleanData(M(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return O(this, arguments, function(e) {
                ...
                S.inArray(this, n) < 0 && (S.cleanData(M(this)),
    ...
    var We, qe, Fe, Be, Ue, Ve, $e, r, Xe = new RegExp("^(" + e + ")(?!px)[a-z%]+$","i"), Ge = /^--/, Ze = new RegExp(h.join("|"),"i"), o = "[\\x20\\t\\r\\n\\f]", Qe = new RegExp("^" + o + "+|((?:^|[^\\\\])(?:\\\\.)*)" + o + "+$","g");
    function Ke(e, t, n) {
        var i, r = Ge.test(t), o = e.style;
        return (n = n || He(e)) && (i = n.getPropertyValue(t) || n[t],
        "" !== (i = r ? i && (i.replace(Qe, "$1") || void 0) : i) || E(e) || (i = S.style(e, t)),
        !g.pixelBoxStyles()) && Xe.test(i) && Ze.test(t) && (r = o.width,
        e = o.minWidth,
        t = o.maxWidth,
    ...
    (r = T.createElement("div")).style && (r.style.backgroundClip = "content-box",
    ...
    function ut(e, t, n, i, r, o) {
        ...
        if (n === (i ? "border" : "content"))
            return 0;
        for (; s < 4; s += 2)
            "margin" === n && (l += S.css(e, n + h[s], !0, r)),
            i ? ("content" === n && (l -= S.css(e, "padding" + h[s], !0, r)),
            "margin" !== n && (l -= S.css(e, "border" + h[s] + "Width", !0, r))) : (l += S.css(e, "padding" + h[s], !0, r),
            "padding" !== n ? l += S.css(e, "border" + h[s] + "Width", !0, r) : a += S.css(e, "border" + h[s] + "Width", !0, r));
    ...
    S.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = b(t), l = Ge.test(t), c = e.style;
                if (l || (t = ot(a)),
                s = S.cssHooks[t] || S.cssHooks[a],
                void 0 === n)
                    return s && "get"in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t];
                "string" == (o = typeof n) && (r = ve.exec(n)) && r[1] && (n = be(e, t, r),
                o = "number"),
    ...
    S.each(["height", "width"], function(e, s) {
        S.cssHooks[s] = {
            get: function(e, t, n) {
                if (t)
                    return !st.test(S.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? dt(e, s, n) : Re(e, at, function() {
                        return dt(e, s, n)
                    })
            },
            set: function(e, t, n) {
    ...
    S.fx = A.prototype.init,
    S.fx.step = {};
    var L, ht, ft = /^(?:toggle|show|hide)$/, pt = /queueHooks$/;
    function mt() {
        ht && (!1 === T.hidden && x.requestAnimationFrame ? x.requestAnimationFrame(mt) : x.setTimeout(mt, S.fx.interval),
        S.fx.tick())
    }
    function gt() {
    ...
    function N(r, e, t) {
        var n, o, i, s, a, l, c, u = 0, d = N.prefilters.length, h = S.Deferred().always(function() {
            delete f.elem
        }), f = function() {
            if (o)
                return !1;
            for (var e = L || gt(), e = Math.max(0, p.startTime + p.duration - e), t = 1 - (e / p.duration || 0), n = 0, i = p.tweens.length; n < i; n++)
                p.tweens[n].run(t);
            ...
            createTween: function(e, t) {
                t = S.Tween(r, p.opts, e, t, p.opts.specialEasing[e] || p.opts.easing);
        ...
        for (i in g)
            ...
            (c = S.cssHooks[s]) && "expand"in c)
                ...
                v[s] = a;
        for (; u < d; u++)
            if (n = N.prefilters[u].call(p, r, m, p.opts))
    ...
    S.Animation = S.extend(N, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, c, u = "width"in t || "height"in t, d = this, h = {}, f = e.style, p = e.nodeType && ge(e), m = _.get(e, "fxshow");
            ...
            if ((l = !S.isEmptyObject(t)) || !S.isEmptyObject(h))
                ...
                null == (c = m && m.display) && (c = _.get(e, "display")),
                "none" === (u = S.css(e, "display")) && (c ? u = c : (C([e], !0),
                c = e.style.display || c,
                u = S.css(e, "display"),
                C([e]))),
                ...
                l = !1,
                h)
                    l || (m ? "hidden"in m && (p = m.hidden) : m = _.access(e, "fxshow", {
                        display: c
                    }),
                    o && (m.hidden = !p),
                    p && C([e], !0),
    ...
    S.fn.extend({
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"),
            this.each(function() {
                var e, t = _.get(this), n = t[s + "queue"], i = t[s + "queueHooks"], r = S.timers, o = n ? n.length : 0;
                for (t.finish = !0,
                S.queue(this, s, []),
    ...
    var bt, _t = S.expr.attrHandle, wt = (S.fn.extend({
        attr: function(e, t) {
    ...
    S.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? S.prop(e, t, n) : (1 === o && S.isXMLDoc(e) || (r = S.attrHooks[t.toLowerCase()] || (S.expr.match.bool.test(t) ? bt : void 0)),
    ...
    S.fn.extend({
        ...
        toggleClass: function(t, n) {
            ...
            }) : "boolean" == typeof n && a ? n ? this.addClass(t) : this.removeClass(t) : (e = Tt(t),
            this.each(function() {
                if (a)
                    for (o = S(this),
                    r = 0; r < e.length; r++)
                    ...
                    void 0 !== t && "boolean" != s || ((i = j(this)) && _.set(this, "__className__", i),
                    this.setAttribute && this.setAttribute("class", !i && !1 !== t && _.get(this, "__className__") || ""))
            }))
        },
        hasClass: function(e) {
    ...
    var kt = /\r/g
      , Et = (S.fn.extend({
        val: function(t) {
            ...
            })) : r ? (n = S.valHooks[r.type] || S.valHooks[r.nodeName.toLowerCase()]) && "get"in n && void 0 !== (e = n.get(r, "value")) ? e : "string" == typeof (e = r.value) ? e.replace(kt, "") : null == e ? "" : e : void 0
        }
    }),
    S.extend({
        valHooks: {
    ...
    /^(?:focusinfocus|focusoutblur)$/)
      , Ct = (S.extend(S.event, {
        trigger: function(e, t, n, i) {
            var r, o, s, a, l, c, u, d = [n || T], h = F.call(e, "type") ? e.type : e, f = F.call(e, "namespace") ? e.namespace.split(".") : [], p = u = o = n = n || T;
            if (3 !== n.nodeType && 8 !== n.nodeType && !Et.test(h + S.event.triggered) && (-1 < h.indexOf(".") && (h = (f = h.split(".")).shift(),
            f.sort()),
            a = h.indexOf(":") < 0 && "on" + h,
            ...
            i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                ...
                for (r = 0; (p = d[r++]) && !e.isPropagationStopped(); )
                    ...
                    (l = (_.get(p, "events") || Object.create(null))[e.type] && _.get(p, "handle")) && l.apply(p, t),
                    (l = a && p[a]) && l.apply && v(p) && (e.result = l.apply(p, t),
                    !1 === e.result) && e.preventDefault();
                return e.type = h,
                i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !v(n) || a && y(n[h]) && !m(n) && ((o = n[a]) && (n[a] = null),
                S.event.triggered = h,
                e.isPropagationStopped() && u.addEventListener(h, St),
                n[h](),
                e.isPropagationStopped() && u.removeEventListener(h, St),
    ...
    g.focusin || S.each({
        ...
        S.event.special[i] = {
            ...
            teardown: function() {
                var e = this.ownerDocument || this.document || this
                  , t = _.access(e, i) - 1;
                t ? _.access(e, i, t) : (e.removeEventListener(n, r, !0),
                _.remove(e, i))
            }
        }
    }),
    ...
    S.extend({
        ...
        ajax: function(e, t) {
            "object" == typeof e && (t = e,
            e = void 0);
            var l, c, u, n, d, h, f, i, r, p = S.ajaxSetup({}, t = t || {}), m = p.context || p, g = p.context && (m.nodeType || m.jquery) ? S(m) : S.event, v = S.Deferred(), y = S.Callbacks("once memory"), b = p.statusCode || {}, o = {}, s = {}, a = "canceled", _ = {
                readyState: 0,
            ...
            !h) {
                ...
                c = p.url.replace(jt, ""),
                p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Pt, "+")) : (r = p.url.slice(c.length),
                p.data && (p.processData || "string" == typeof p.data) && (c += (Mt.test(c) ? "&" : "?") + p.data,
                delete p.data),
                !1 === p.cache && (c = c.replace(Yt, "$1"),
                r = (Mt.test(c) ? "&" : "?") + "_=" + Dt.guid++ + r),
                p.url = c + r),
                p.ifModified && (S.lastModified[c] && _.setRequestHeader("If-Modified-Since", S.lastModified[c]),
                S.etag[c]) && _.setRequestHeader("If-None-Match", S.etag[c]),
            ...
            function w(e, t, n, i) {
                ...
                i ? (p.ifModified && ((n = _.getResponseHeader("Last-Modified")) && (S.lastModified[c] = n),
                n = _.getResponseHeader("etag")) && (S.etag[c] = n),
    ...
    var Gt = []
      ...
      , Qt = (S.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Gt.pop() || S.expando + "_" + Dt.guid++;
            return this[e] = !0,
            e
        }
    }),
    S.ajaxPrefilter("json jsonp", function(e, t, n) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
            ...
            s ? e[s] = e[s].replace(Zt, "$1" + i) : !1 !== e.jsonp && (e.url += (Mt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
            ...
            ,
            n.always(function() {
                void 0 === r ? S(x).removeProp(i) : x[i] = r,
    ...
    g.createHTMLDocument = ((o = T.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    S.parseHTML = function(e, t, n) {
        ...
        i = !n && [],
        (n = Q.exec(e)) ? [t.createElement(n[1])] : (n = Ee([e], t, i),
    ...
    S.offset = {
        setOffset: function(e, t, n) {
            ...
            parseFloat(s) || 0),
            null != (t = y(t) ? t.call(e, n, S.extend({}, o)) : t).top && (c.top = t.top - o.top + r),
    ...
    return S.noConflict = function(e) {
        return x.$ === S && (x.$ = Jt),
        e && x.jQuery === S && (x.jQuery = Kt),
        S
    }
    ,
    void 0 === Y && (x.jQuery = x.$ = S),
    S
}),
function(e, t) {
    ...
    function u(e) {
        return d(b(e)).left + l(e).scrollLeft
    }
    function _(e) {
    ...
    function W(e, t, n) {
        ...
        return !r && n || ("body" === a(t) && !h(i) || (o = (r = t) !== y(r) && c(r) ? {
            scrollLeft: r.scrollLeft,
            scrollTop: r.scrollTop
        } : l(r)),
        c(t) ? ((s = d(t)).x += t.clientLeft,
    ...
    function s(e) {
        return "html" === a(e) ? e : e.assignedSlot || e.parentNode || (r(e) ? e.host : null) || b(e)
    }
    function g(e, t) {
        void 0 === t && (t = []);
        var n = function e(t) {
            return 0 <= ["html", "body", "#document"].indexOf(a(t)) ? t.ownerDocument.body : c(t) && h(t) ? t : e(s(t))
        }(e)
          , e = n === (null == (e = e.ownerDocument) ? void 0 : e.body)
          , i = y(n)
          , i = e ? [i].concat(i.visualViewport || [], h(n) ? n : []) : n
          , n = t.concat(i);
    ...
    function k(e) {
        for (var t, n = y(e), i = o(e); i && (t = i,
        0 <= ["table", "td", "th"].indexOf(a(t))) && "static" === _(i).position; )
            i = o(i);
        return (!i || "html" !== a(i) && ("body" !== a(i) || "static" !== _(i).position)) && (i || function(e) {
    ...
    var x = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s'
      , X = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available'
    ...
    function K(e, t) {
        ...
        a = i.offsetTop)),
        {
            ...
            x: s + u(n),
            y: a
        })) : c(t) ? ((o = d(i = t)).top = o.top + i.clientTop,
        ...
        t = E(s.scrollWidth, s.clientWidth, a ? a.scrollWidth : 0, a ? a.clientWidth : 0),
        e = E(s.scrollHeight, s.clientHeight, a ? a.scrollHeight : 0, a ? a.clientHeight : 0),
        r = -n.scrollLeft + u(r),
        n = -n.scrollTop,
        "rtl" === _(a || s).direction && (r += E(s.clientWidth, a ? a.clientWidth : 0) - t),
        {
            width: t,
            height: e,
            x: r,
    ...
    function J(n, e, t) {
        ...
        m(i = 0 <= ["absolute", "fixed"].indexOf(_(r).position) && c(r) ? k(r) : r) ? o.filter(function(e) {
            return m(e) && Z(e, i) && "body" !== a(e)
        }) : []) : [].concat(e), o = [].concat(r, [t]), e = o[0], t = o.reduce(function(e, t) {
            t = K(n, t);
            return e.top = E(t.top, e.top),
    ...
    function te(e) {
        var t, n = e.reference, i = e.element, e = e.placement, r = e ? P(e) : null, e = e ? Y(e) : null, o = n.x + n.width / 2 - i.width / 2, s = n.y + n.height / 2 - i.height / 2;
        switch (r) {
        case C:
            t = {
                x: o,
    ...
    function I(e, t) {
        var i, t = t = void 0 === t ? {} : t, n = t.placement, n = void 0 === n ? e.placement : n, r = t.boundary, r = void 0 === r ? q : r, o = t.rootBoundary, o = void 0 === o ? F : o, s = t.elementContext, s = void 0 === s ? p : s, a = t.altBoundary, a = void 0 !== a && a, t = t.padding, t = void 0 === t ? 0 : t, t = ie("number" != typeof t ? t : re(t, L)), l = e.elements.reference, c = e.rects.popper, a = e.elements[a ? s === p ? B : p : s], a = J(m(a) ? a : a.contextElement || b(e.elements.popper), r, o), r = d(l), o = te({
            reference: r,
            element: c,
            strategy: "absolute",
            placement: n
        }), l = Q(Object.assign({}, c, o)), c = s === p ? l : r, u = {
        ...
        Object.keys(u).forEach(function(e) {
            var t = 0 <= [M, D].indexOf(e) ? 1 : -1
              , n = 0 <= [C, D].indexOf(e) ? "y" : "x";
            u[e] += i[n] * t
        })),
        u
    }
        ...
        return function(s, a, t) {
            ...
            var n, i, l = {
                ...
                setOptions: function(e) {
                    ...
                    e = [].concat(f, l.options.modifiers),
                    ...
                    n = $(e);
                    var n, t, i, r, o, e = v.reduce(function(e, t) {
                    ...
                    e.filter(function(e) {
                        ...
                        Object.keys(n).forEach(function(e) {
                            switch (e) {
                            case "name":
                                "string" != typeof n.name && console.error(w(x, String(n.name), '"name"', '"string"', '"' + String(n.name) + '"'));
                                break;
                            case "enabled":
                                "boolean" != typeof n.enabled && console.error(w(x, n.name, '"enabled"', '"boolean"', '"' + String(n.enabled) + '"'));
                            case "phase":
                                v.indexOf(n.phase) < 0 && console.error(w(x, n.name, '"phase"', "either " + v.join(", "), '"' + String(n.phase) + '"'));
                                break;
                            case "fn":
                                "function" != typeof n.fn && console.error(w(x, n.name, '"fn"', '"function"', '"' + String(n.fn) + '"'));
                                break;
                            case "effect":
                                "function" != typeof n.effect && console.error(w(x, n.name, '"effect"', '"function"', '"' + String(n.fn) + '"'));
                                break;
                            case "requires":
                                Array.isArray(n.requires) || console.error(w(x, n.name, '"requires"', '"array"', '"' + String(n.requires) + '"'));
                                break;
                            case "requiresIfExists":
                                Array.isArray(n.requiresIfExists) || console.error(w(x, n.name, '"requiresIfExists"', '"array"', '"' + String(n.requiresIfExists) + '"'));
                                break;
                            case "options":
                            case "data":
                                break;
                            default:
                                console.error('PopperJS: an invalid property has been provided to the "' + n.name + '" modifier, valid properties are ' + G.map(function(e) {
                                    return '"' + e + '"'
                            ...
                            n.requires && n.requires.forEach(function(t) {
                                null == i.find(function(e) {
                                    return e.name === t
                                }) && console.error(w(X, String(n.name), t, t))
                            })
                        })
                    }),
                    P(l.options.placement) !== A || l.orderedModifiers.find(function(e) {
                        return "flip" === e.name
                ...
                forceUpdate: function() {
                    if (!u) {
                        ...
                        if (ae(t, e)) {
                            l.rects = {
                                reference: W(t, k(e), "fixed" === l.options.strategy),
                                popper: S(e)
                            },
                            l.reset = !1,
            ...
            return ae(s, a) ? d.setOptions(t).then(function(e) {
    ...
    var n = {
        ...
        effect: function(e) {
            ...
            o && s.addEventListener("resize", n.update, z),
            function() {
                r && a.forEach(function(e) {
                    e.removeEventListener("scroll", n.update, z)
                }),
                o && s.removeEventListener("resize", n.update, z)
            }
        },
        data: {}
    };
    ...
    function ce(e) {
        var t, n, i, r = e.popper, o = e.popperRect, s = e.placement, a = e.offsets, l = e.position, c = e.gpuAcceleration, u = e.adaptive, e = e.roundOffsets, d = !0 === e ? (d = (h = a).x,
        h = a.y,
        f = window.devicePixelRatio || 1,
        {
            x: T(T(d * f) / f) || 0,
            y: T(T(h * f) / f) || 0
        }) : "function" == typeof e ? e(a) : a, h = d.x, f = void 0 === h ? 0 : h, e = d.y, e = void 0 === e ? 0 : e, p = a.hasOwnProperty("x"), a = a.hasOwnProperty("y"), m = O, g = C, v = window, r = (u && (i = "clientHeight",
        n = "clientWidth",
        (t = k(r)) === y(r) && "static" !== _(t = b(r)).position && (i = "scrollHeight",
        n = "scrollWidth"),
        s === C && (g = D,
        e = (e - (t[i] - o.height)) * (c ? 1 : -1)),
        s === O) && (m = M,
        f = (f - (t[n] - o.width)) * (c ? 1 : -1)),
        Object.assign({
            position: l
        }, u && le));
        return c ? Object.assign({}, r, ((i = {})[g] = a ? "0" : "",
        i[m] = p ? "0" : "",
        i.transform = (v.devicePixelRatio || 1) < 2 ? "translate(" + f + "px, " + e + "px)" : "translate3d(" + f + "px, " + e + "px, 0)",
    ...
    var ue = {
        ...
        fn: function(e) {
            var t = e.state
              ...
              , r = _(t.elements.popper).transitionProperty || ""
    ...
    var ge = {
        ...
        fn: function(e) {
            ...
            if (!d.modifiersData[e]._skip) {
                for (var n = t.mainAxis, i = void 0 === n || n, n = t.altAxis, r = void 0 === n || n, n = t.fallbackPlacements, h = t.padding, f = t.boundary, p = t.rootBoundary, o = t.altBoundary, s = t.flipVariations, m = void 0 === s || s, g = t.allowedAutoPlacements, s = d.options.placement, t = P(s), n = n || (t === s || !m ? [H(s)] : P(n = s) === A ? [] : (t = H(n),
                [me(n), t, me(t)])), a = [s].concat(n).reduce(function(e, t) {
                    return e.concat(P(t) === A ? (n = d,
                    i = (e = e = void 0 === (e = {
                        placement: t,
                        boundary: f,
                        rootBoundary: p,
                    ...
                    s = e.padding,
                    a = e.flipVariations,
                    l = void 0 === (e = e.allowedAutoPlacements) ? V : e,
                    c = Y(i),
                    e = c ? a ? U : U.filter(function(e) {
                        return Y(e) === c
                    }) : L,
    ...
    var ve = {
        ...
        phase: "main",
        fn: function(e) {
            var t, n, i, r, o, s, a, l, c, u = e.state, d = e.options, e = e.name, h = void 0 === (h = d.mainAxis) || h, f = void 0 !== (f = d.altAxis) && f, p = d.boundary, m = d.rootBoundary, g = d.altBoundary, v = d.padding, y = void 0 === (y = d.tether) || y, d = void 0 === (d = d.tetherOffset) ? 0 : d, p = I(u, {
                boundary: p,
                rootBoundary: m,
                padding: v,
                altBoundary: g
            }), m = P(u.placement), g = !(v = Y(u.placement)), b = "x" === (m = ee(m)) ? "y" : "x", _ = u.modifiersData.popperOffsets, w = u.rects.reference, x = u.rects.popper, d = "function" == typeof d ? d(Object.assign({}, u.rects, {
                placement: u.placement
            })) : d, T = {
                x: 0,
                y: 0
            };
            _ && ((h || f) && (o = "y" === m ? "height" : "width",
            t = _[m],
            n = _[m] + p[c = "y" === m ? C : O],
            i = _[m] - p[a = "y" === m ? D : M],
            s = y ? -x[o] / 2 : 0,
            ...
            l = l[a],
            a = R(0, w[o], x[o]),
            x = g ? w[o] / 2 - s - a - c - d : r - a - c - d,
            r = g ? -w[o] / 2 + s + a + l + d : v + a + l + d,
            g = (c = u.elements.arrow && k(u.elements.arrow)) ? "y" === m ? c.clientTop || 0 : c.clientLeft || 0 : 0,
            w = u.modifiersData.offset ? u.modifiersData.offset[u.placement][m] : 0,
            o = _[m] + x - w - g,
            s = _[m] + r - w,
            h && (v = R(y ? j(n, o) : n, t, y ? E(i, s) : i),
            _[m] = v,
            T[m] = v - t),
            f) && (l = (a = _[b]) + p["x" === m ? C : O],
            d = a - p["x" === m ? D : M],
            c = R(y ? j(l, o) : l, a, y ? E(d, s) : d),
            _[b] = c,
            T[b] = c - a),
            u.modifiersData[e] = T)
        },
    ...
    var ye = {
        ...
        phase: "main",
        fn: function(e) {
            var t, n, i, r, o = e.state, s = e.name, e = e.options, a = o.elements.arrow, l = o.modifiersData.popperOffsets, c = ee(u = P(o.placement)), u = 0 <= [O, M].indexOf(u) ? "height" : "width";
            a && l && (e = e.padding,
            n = o,
    ...
    function _e(t) {
        return [C, M, D, O].some(function(e) {
            return 0 <= t[e]
        })
    }
    var we = {
      ...
      , xe = t({
        defaultModifiers: [n, i, ue, de]
    })
      , Te = [n, i, ue, de, he, ge, ve, ye, we]
      , Se = t({
        defaultModifiers: Te
    });
    e.applyStyles = de,
    ...
    e.popperGenerator = t,
    e.popperOffsets = i,
    e.preventOverflow = ve,
    Object.defineProperty(e, "__esModule", {
        value: !0
    })
}),
function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t(require("popper.html")) : "function" == typeof define && define.amd ? define(["popper.js"], t) : e.Tooltip = t(e.Popper)
}(this, function(r) {
    "use strict";
...
function(e, t) {
    ...
    const u = e => {
      ...
      , V = (n, i, e=!0) => {
        if (e) {
            ...
            const r = ({target: e}) => {
                e === i && (t = !0,
                i.removeEventListener(z, r),
                u(n))
            }
            ;
            i.addEventListener(z, r),
            setTimeout( () => {
                t || W(i)
            }
            , e)
    ...
    function oe(i, r, o, s, a) {
        if ("string" == typeof r && i) {
            ...
            var l, c, u, d, h, f, s = ne(i), s = s[n] || (s[n] = {}), p = ie(s, t, e ? o : null);
            p ? p.oneOff = p.oneOff && a : (p = te(t, r.replace(X, "")),
            (r = e ? (d = i,
            h = o,
            f = t,
            function t(n) {
                var i = d.querySelectorAll(h);
        ...
        off(e, t, n, i) {
            if ("string" == typeof t && e) {
                var [i,r,o] = re(t, n, i)
                  ...
                  , c = t.startsWith(".");
                if (void 0 !== r)
                    return Object.keys(l).length ? void se(e, a, o, r, i ? n : null) : void 0;
                if (c)
                    for (const v of Object.keys(a)) {
                        u = m = p = f = h = d = void 0;
                        var u, d = e, h = a, f = v, p = t.slice(1), m = h[f] || {};
                        for (const y of Object.keys(m))
                            y.includes(p) && se(d, h, f, (u = m[y]).callable, u.delegationSelector)
                    }
                for (const b of Object.keys(l)) {
                    var g = b.replace(Z, "");
                    s && !t.includes(g) || se(e, a, o, (g = l[b]).callable, g.delegationSelector)
                }
            }
        },
        trigger(e, t, n) {
    ...
    const h = {
        ...
        getDataAttributes(t) {
            ...
            for (const i of Object.keys(t.dataset).filter(e => e.startsWith("bs") && !e.startsWith("bsConfig"))) {
                let e = i.replace(/^bs/, "");
                n[e = e.charAt(0).toLowerCase() + e.slice(1, e.length)] = ue(t.dataset[i])
            }
            return n
        },
    ...
    class t {
        ...
        _typeCheckConfig(e, t=this.constructor.DefaultType) {
            for (const r of Object.keys(t)) {
                var n = t[r]
                  , i = e[r]
                  , i = o(i) ? "element" : null == (i = i) ? "" + i : Object.prototype.toString.call(i).match(/\s([a-z]+)/i)[1].toLowerCase();
    ...
    var he = (t, n="hide") => {
        ...
        const i = t.NAME;
        m.on(document, e, `[data-bs-dismiss="${i}"]`, function(e) {
    ...
    m.on(document, "click.bs.button.data-api", pe, e => {
        e.preventDefault();
    ...
    class ye extends t {
        ...
        _handleSwipe() {
            ...
            this._deltaX = 0,
            e && u(0 < e ? this._config.rightCallback : this._config.leftCallback))
        }
        _initEvents() {
    ...
    class w extends f {
        ...
        pause() {
            this._isSliding && W(this._element),
            this._clearInterval()
        }
        cycle() {
            this._clearInterval(),
        ...
        _maybeEnableCycle() {
            this._config.ride && (this._isSliding ? m.one(this._element, _e, () => this.cycle()) : this.cycle())
        }
        to(e) {
            var t, n = this._getItems();
            e > n.length - 1 || e < 0 || (this._isSliding ? m.one(this._element, _e, () => this.to(e)) : (t = this._getItemIndex(this._getActive())) !== e && (t = t < e ? y : b,
            this._slide(t, n[e])))
        }
        dispose() {
        ...
        _addTouchEventListeners() {
            for (const t of p.find(".carousel-item img", this._element))
        ...
        _keydown(e) {
            var t;
            /input|textarea/i.test(e.target.tagName) || (t = ke[e.key]) && (e.preventDefault(),
        ...
        _setActiveIndicatorElement(e) {
            var t;
            this._indicatorsElement && ((t = p.findOne(Te, this._indicatorsElement)).classList.remove(xe),
            t.removeAttribute("aria-current"),
            t = p.findOne(`[data-bs-slide-to="${e}"]`, this._indicatorsElement)) && (t.classList.add(xe),
        ...
        _slide(t, e=null) {
            if (!this._isSliding) {
                ...
                var n = t === y;
                const r = e || $(this._getItems(), i, n, this._config.wrap);
                if (r !== i) {
                    const o = this._getItemIndex(r)
                      , s = e => m.trigger(this._element, e, {
                        relatedTarget: r,
        ...
        _directionToOrder(e) {
            return l() ? e === _ ? b : y : e === _ ? y : b
        }
        _orderToDirection(e) {
            return l() ? e === b ? _ : be : e === b ? be : _
        }
        static jQueryInterface(t) {
            return this.each(function() {
    ...
    m.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", function(e) {
        var t = r(this);
        t && t.classList.contains(we) && (e.preventDefault(),
        e = w.getOrCreateInstance(t),
    ...
    m.on(window, "load.bs.carousel.data-api", () => {
        for (const e of p.find('[data-bs-ride="carousel"]'))
    ...
    class T extends f {
        constructor(e, t) {
            ...
            this._triggerArray = [];
            for (const r of p.find(Oe)) {
                var n = R(r)
                  , i = p.find(n).filter(e => e === this._element);
        ...
        show() {
            if (!this._isTransitioning && !this._isShown()) {
                let e = [];
                if (!(e = this._config.parent ? this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(e => e !== this._element).map(e => T.getOrCreateInstance(e, {
                    toggle: !1
                    ...
                    if (!t.defaultPrevented) {
                        ...
                        this._queueCallback( () => {
                            ...
                            this._element.classList.add(x, De),
        ...
        hide() {
            if (!this._isTransitioning && this._isShown()) {
                ...
                if (!e.defaultPrevented) {
                    ...
                    c(this._element),
                    this._element.classList.add(Me),
                    this._element.classList.remove(x, De);
        ...
        static jQueryInterface(t) {
            ...
            this.each(function() {
                var e = T.getOrCreateInstance(this, n);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    m.on(document, "click.bs.collapse.data-api", Oe, function(e) {
        ("A" === e.target.tagName || e.delegateTarget && "A" === e.delegateTarget.tagName) && e.preventDefault();
        e = R(this);
        for (const t of p.find(e))
    ...
    const k = "show"
      ...
      , Ye = (E,
    ".dropdown-menu")
      , Ie = l() ? "top-end" : "top-start"
      , ze = l() ? "top-start" : "top-end"
      , He = l() ? "bottom-end" : "bottom-start"
      , Re = l() ? "bottom-start" : "bottom-end"
      , We = l() ? "left-start" : "right-start"
      , qe = l() ? "right-start" : "left-start"
      , Fe = {
        autoClose: !0,
    ...
    class C extends f {
        constructor(e, t) {
            ...
            this._menu = p.next(this._element, Ye)[0] || p.prev(this._element, Ye)[0] || p.findOne(Ye, this._parent),
        ...
        _getConfig(e) {
            if ("object" != typeof (e = super._getConfig(e)).reference || o(e.reference) || "function" == typeof e.reference.getBoundingClientRect)
                return e;
            throw new TypeError(Ne.toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.')
        }
        _createPopper() {
            if (void 0 === n)
        ...
        _isShown() {
            return this._menu.classList.contains(k)
        }
        _getPlacement() {
            var e, t = this._parent;
            return t.classList.contains("dropend") ? We : t.classList.contains("dropstart") ? qe : t.classList.contains("dropup-center") ? "top" : t.classList.contains("dropdown-center") ? "bottom" : (e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim(),
            t.classList.contains("dropup") ? e ? ze : Ie : e ? Re : He)
        }
        _detectNavbar() {
        ...
        _selectMenuItem({key: e, target: t}) {
            var n = p.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter(e => s(e));
            n.length && $(n, t, e === Pe, !n.includes(t)).focus()
        }
        static jQueryInterface(t) {
            return this.each(function() {
        ...
        static clearMenus(e) {
            if (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                for (const r of p.find('[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled).show')) {
                    var t, n, i = C.getInstance(r);
        ...
        static dataApiKeydownHandler(e) {
            var t = /input|textarea/i.test(e.target.tagName)
              , n = "Escape" === e.key
              , i = ["ArrowUp", Pe].includes(e.key);
            !i && !n || t && !n || (e.preventDefault(),
            t = this.matches(E) ? this : p.prev(this, E)[0] || p.next(this, E)[0] || p.findOne(E, e.delegateTarget.parentNode),
    ...
    m.on(document, v, E, C.dataApiKeydownHandler),
    m.on(document, v, Ye, C.dataApiKeydownHandler),
    m.on(document, je, C.clearMenus),
    m.on(document, "keyup.bs.dropdown.data-api", C.clearMenus),
    m.on(document, je, E, function(e) {
        e.preventDefault(),
        C.getOrCreateInstance(this).toggle()
    }),
    e(C);
    ...
    class Ge {
        ...
        hide() {
            ...
            this._setElementAttributes(this._element, $e, e => e + t),
            this._setElementAttributes(Ue, $e, e => e + t),
            this._setElementAttributes(Ve, Xe, e => e - t)
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"),
            this._resetElementAttributes(this._element, $e),
            this._resetElementAttributes(Ue, $e),
            this._resetElementAttributes(Ve, Xe)
        }
        isOverflowing() {
        ...
        _resetElementAttributes(e, n) {
            this._applyManipulationCallback(e, e => {
                ...
                null === t ? e.style.removeProperty(n) : (h.removeDataAttribute(e, n),
        ...
        _applyManipulationCallback(e, t) {
            if (o(e))
                ...
                for (const n of p.find(e, this._element))
                    t(n)
        }
    }
    const Ze = "backdrop"
    ...
    class et extends t {
        ...
        dispose() {
            this._isAppended && (m.off(this._element, Qe),
            this._element.remove(),
            this._isAppended = !1)
        }
        _getElement() {
    ...
    class ot extends t {
        ...
        _handleFocusin(e) {
            ...
            e.target === document || e.target === t || t.contains(e.target) || (0 === (e = p.focusableChildren(t)).length ? t : this._lastTabNavDirection === nt ? e[e.length - 1] : e[0]).focus()
        }
        _handleKeydown(e) {
    ...
    class M extends f {
        ...
        show(e) {
            this._isShown || this._isTransitioning || m.trigger(this._element, at, {
                relatedTarget: e
        ...
        _addEventListeners() {
            m.on(this._element, "keydown.dismiss.bs.modal", e => {
                "Escape" === e.key && (this._config.keyboard ? (e.preventDefault(),
        ...
        _triggerBackdropTransition() {
            ...
            if (!e.defaultPrevented) {
                ...
                "hidden" === t || this._element.classList.contains(ct) || (e || (this._element.style.overflowY = "hidden"),
    ...
    class O extends f {
        ...
        _initializeBackDrop() {
            ...
            return new et({
                ...
                clickCallback: e ? () => {
                    "static" === this._config.backdrop ? m.trigger(this._element, pt) : this.hide()
                }
                : null
            })
        }
        ...
        _addEventListeners() {
            m.on(this._element, "keydown.dismiss.bs.offcanvas", e => {
                "Escape" === e.key && (this._config.keyboard ? this.hide() : m.trigger(this._element, pt))
            }
            )
        }
        static jQueryInterface(t) {
    ...
    m.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(e) {
        ...
        (e = p.findOne(ft)) && e !== t && O.getInstance(e).hide(),
        O.getOrCreateInstance(t).toggle(this))
    }),
    m.on(window, "load.bs.offcanvas.data-api", () => {
        for (const e of p.find(ft))
            O.getOrCreateInstance(e).show()
    }
    ),
    m.on(window, "resize.bs.offcanvas", () => {
        for (const e of p.find("[aria-modal][class*=show][class*=offcanvas-]"))
            "fixed" !== getComputedStyle(e).position && O.getOrCreateInstance(e).hide()
    }
    ),
    he(O),
    e(O);
    const yt = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"]);
    const bt = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i
            ...
            if (Object.keys(t).includes(i)) {
                ...
                for (const a of r)
                    ( (e, t) => {
                        ...
                        return t.includes(n) ? !yt.has(n) || Boolean(bt.test(e.nodeValue) || _t.test(e.nodeValue)) : t.filter(e => e instanceof RegExp).some(e => e.test(n))
                    }
    ...
    const Et = new Set(["sanitize", "allowList", "sanitizeFn"])
      , Ct = "fade";
    const Dt = "show"
      , Mt = "hide.bs.modal"
      , A = "hover"
    ...
    class L extends f {
        ...
        dispose() {
            ...
            m.off(this._element.closest(".modal"), Mt, this._hideModalHandler),
        ...
        hide() {
            if (this._isShown()) {
                ...
                if (!e.defaultPrevented) {
                    if (this._getTipElement().classList.remove(Dt),
                    "ontouchstart"in document.documentElement)
        ...
        _createTipElement(e) {
            ...
            this._isAnimated() && e.classList.add(Ct),
            e
        }
        setContent(e) {
            this._newContent = e,
        ...
        _getTemplateFactory(e) {
            return this._templateFactory ? this._templateFactory.changeContent(e) : this._templateFactory = new kt({
                ...this._config,
                content: e,
        ...
        _isAnimated() {
            return this._config.animation || this.tip && this.tip.classList.contains(Ct)
        }
        _isShown() {
        ...
        _setListeners() {
            ...
            for (const n of this._config.trigger.split(" "))
                "click" === n ? m.on(this._element, this.constructor.eventName("click"), this._config.selector, e => {
                    this._initializeOnDelegatedTarget(e).toggle()
                }
                ) : "manual" !== n && (e = n === A ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
                t = n === A ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout"),
                m.on(this._element, e, this._config.selector, e => {
                    var t = this._initializeOnDelegatedTarget(e);
                    t._activeTrigger["focusin" === e.type ? Ot : A] = !0,
                    t._enter()
                }
                ),
                m.on(this._element, t, this._config.selector, e => {
                    var t = this._initializeOnDelegatedTarget(e);
                    t._activeTrigger["focusout" === e.type ? Ot : A] = t._element.contains(e.relatedTarget),
                    t._leave()
                }
                ));
            ...
            ,
            m.on(this._element.closest(".modal"), Mt, this._hideModalHandler)
        }
        _fixTitle() {
    ...
    class Yt extends L {
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                var e = Yt.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t]()
    ...
    class Wt extends f {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (m.off(this._config.target, It),
            m.on(this._config.target, It, zt, e => {
        ...
        _initializeTargetsAndObservables() {
            ...
            this._targetLinks = new Map,
            this._observableSections = new Map;
            for (const t of p.find(zt, this._config.target))
                t.hash && !a(t) && (e = p.findOne(t.hash, this._element),
                s(e)) && (this._targetLinks.set(t.hash, t),
                this._observableSections.set(t.hash, e))
        }
        _process(e) {
            this._activeTarget !== e && (this._clearActiveClass(this._config.target),
            (this._activeTarget = e).classList.add(N),
        ...
        _activateParents(e) {
            if (e.classList.contains("dropdown-item"))
                p.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(N);
            else
                for (const t of p.parents(e, ".nav, .list-group"))
                    for (const n of p.prev(t, ".nav-link, .nav-item > .nav-link, .list-group-item"))
                        n.classList.add(N)
        }
        _clearActiveClass(e) {
            e.classList.remove(N);
            for (const t of p.find(zt + "." + N, e))
    ...
    m.on(window, "load.bs.scrollspy.data-api", () => {
        for (const e of p.find('[data-bs-spy="scroll"]'))
            Wt.getOrCreateInstance(e)
    }
    ),
    e(Wt);
    const qt = "ArrowRight"
    ...
    const Ut = '.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ' + S;
    P,
    P,
    P;
    class j extends f {
        ...
        show() {
            ...
            this._elemIsActive(n) || (t = (e = this._getActiveElem()) ? m.trigger(e, "hide.bs.tab", {
                relatedTarget: n
            }) : null,
            m.trigger(n, "show.bs.tab", {
                relatedTarget: e
        ...
        _activate(e, t) {
            ...
            this._activate(r(e)),
            this._queueCallback( () => {
                "tab" !== e.getAttribute("role") ? e.classList.add(Bt) : (e.removeAttribute("tabindex"),
        ...
        _deactivate(e, t) {
            ...
            this._queueCallback( () => {
                "tab" !== e.getAttribute("role") ? e.classList.remove(Bt) : (e.setAttribute("aria-selected", !1),
        ...
        _keydown(e) {
            var t;
            ["ArrowLeft", qt, "ArrowUp", Ft].includes(e.key) && (e.stopPropagation(),
            e.preventDefault(),
            t = [qt, Ft].includes(e.key),
            e = $(this._getChildren().filter(e => !a(e)), e.target, t, !0)) && (e.focus({
                preventScroll: !0
            }),
            j.getOrCreateInstance(e).show())
        }
        _getChildren() {
            return p.find(Ut, this._parent)
        }
        _getActiveElem() {
        ...
        _getInnerElement(e) {
            return e.matches(Ut) ? e : p.findOne(Ut, e)
        }
        _getOuterElement(e) {
    ...
    m.on(document, "click.bs.tab", S, function(e) {
        ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
        a(this) || j.getOrCreateInstance(this).show()
    }),
    m.on(window, "load.bs.tab", () => {
        for (const e of p.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]'))
    ...
    class Zt extends f {
        ...
        show() {
            ...
            c(this._element),
            this._element.classList.add(Vt, $t),
            this._queueCallback( () => {
        ...
        hide() {
            this.isShown() && !m.trigger(this._element, "hide.bs.toast").defaultPrevented && (this._element.classList.add($t),
            this._queueCallback( () => {
                this._element.classList.add("hide"),
                this._element.classList.remove($t, Vt),
        ...
        dispose() {
            this._clearTimeout(),
            this.isShown() && this._element.classList.remove(Vt),
            super.dispose()
        }
        isShown() {
        ...
        static jQueryInterface(t) {
            return this.each(function() {
                var e = Zt.getOrCreateInstance(this, t);
                if ("string" == typeof t) {
                    if (void 0 === e[t])
                        throw new TypeError(`No method named "${t}"`);
                    e[t](this)
...
function(e) {
    ...
    "use strict";
    for (var o, t, n, D = !1, M = !1, O = 0, A = 2e3, L = 0, N = e, P = document, j = window, Y = N(j), I = [], z = j.requestAnimationFrame || j.webkitRequestAnimationFrame || j.mozRequestAnimationFrame || !1, H = j.cancelAnimationFrame || j.webkitCancelAnimationFrame || j.mozCancelAnimationFrame || !1, R = (z ? j.cancelAnimationFrame || (H = function(e) {}
    ) : (o = 0,
    z = function(e, t) {
    ...
    j.MutationObserver || j.WebKitMutationObserver || !1), W = Date.now || function() {
    ...
    , q = {
        ...
        function n() {
            var e = g.doc.css(b.trstyle);
            return !(!e || "matrix" != e.substr(0, 6)) && e.replace(/^.*\((.*)\)$/g, "$1").replace(/px/g, "").split(/, +/)
        }
        function r(e, t, n) {
            var e = e.css(t)
              , t = parseFloat(e);
            return !isNaN(t) || (e = 3 == (t = p[e] || 0) ? n ? g.win.outerHeight() - g.win.innerHeight() : g.win.outerWidth() - g.win.innerWidth() : 1,
            g.isie8 && t && (t += 1),
            e) ? t : 0
        }
        function o(n, i, r, e) {
        ...
        function s(e, t, n, i) {
            ...
            if (t) {
                ...
                t < 0 ? i >= g.page.maxh : i <= 0) {
                    if (y.nativeparentscrolling && n && !g.ispage && !g.zoomactive)
                        return 1;
                    r = g.view.h >> 1;
                ...
                i = 0 < t ? 1 : -1;
                T !== i && (g.scrollmom && g.scrollmom.stop(),
        ...
        function i(e, t, n) {
            var i, r;
            return !(n || !C) || (0 === e.deltaMode ? (i = -e.deltaX * (y.mousescrollstep / 54) | 0,
            r = -e.deltaY * (y.mousescrollstep / 54) | 0) : 1 === e.deltaMode && (i = -e.deltaX * y.mousescrollstep * 50 / 80 | 0,
            r = -e.deltaY * y.mousescrollstep * 50 / 80 | 0),
            t && y.oneaxismousemode && 0 === i && r && (i = r,
            r = 0,
            n) && (i < 0 ? g.getScrollLeft() >= g.page.maxw : g.getScrollLeft() <= 0) && (r = i,
            i = 0),
            s(i = g.isrtlmode ? -i : i, r, n, !0) ? void (n && (C = !0)) : (C = !1,
            e.stopImmediatePropagation(),
            e.preventDefault()))
        }
        var a, l, c, u, g = this, v = (this.version = "3.7.6",
        ...
        e)
            for (var d in y)
                void 0 !== e[d] && (y[d] = e[d]);
        if (y.disablemutationobserver && (R = !1),
        this.doc = y.doc,
        this.iddoc = this.doc && this.doc[0] && this.doc[0].id || "",
        this.ispage = /^BODY|HTML/.test((y.win || this.doc)[0].nodeName),
        this.haswrapper = !1 !== y.win,
        this.win = y.win || (this.ispage ? Y : this.doc),
        this.docscroll = this.ispage && !this.haswrapper ? Y : this.win,
        this.body = v,
        this.viewport = !1,
        this.isfixed = !1,
        this.iframe = !1,
        ...
        this.forcescreen = !1,
        this.canshowonmouseevent = "scroll" != y.autohidemode,
        this.onmousedown = !1,
        this.onmouseup = !1,
        this.onmousemove = !1,
        this.onmousewheel = !1,
        ...
        "auto" == y.rtlmode ? "horizontal-tb" == (l = (t = this.win[0] == j ? this.body : this.win).css("writing-mode") || t.css("-webkit-writing-mode") || t.css("-ms-writing-mode") || t.css("-moz-writing-mode")) || "lr-tb" == l || "" === l ? (this.isrtlmode = "rtl" == t.css("direction"),
        this.isvertical = !1) : (this.isrtlmode = "vertical-rl" == l || "tb" == l || "tb-rl" == l || "rl-tb" == l,
        this.isvertical = "vertical-rl" == l || "tb" == l || "tb-rl" == l) : (this.isrtlmode = !0 === y.rtlmode,
        this.isvertical = !1),
        this.scrollrunning = !1,
        this.scrollmom = !1,
        this.observer = !1,
        this.observerremover = !1,
        (this.observerbody = !1) !== y.scrollbarid)
            this.id = y.scrollbarid;
        else
            for (; this.id = "ascrail" + A++,
        ...
        this.overflowx = y.overflowx,
        this.overflowy = y.overflowy,
        ...
        var f, b = N.extend({}, this.detected), p = (this.canhwscroll = b.hastransform && y.hwacceleration,
        ...
        y.enablemouselockapi || (b.hasmousecapture = !1,
        b.haspointerlock = !1),
        ...
        ,
        f = this.isrtlmode ? 1 : -1,
        b.hastranslate3d && y.enabletranslate3d ? (this.setScrollTop = function(e, t) {
            g.doc.translate.y = e,
            g.doc.translate.ty = -1 * e + "px",
            g.doc.css(b.trstyle, "translate3d(" + g.doc.translate.tx + "," + g.doc.translate.ty + ",0)"),
            t || g.notifyScrollEvent(g.win[0])
        }
        ,
        this.setScrollLeft = function(e, t) {
            g.doc.translate.x = e,
            g.doc.translate.tx = e * f + "px",
            g.doc.css(b.trstyle, "translate3d(" + g.doc.translate.tx + "," + g.doc.translate.ty + ",0)"),
            t || g.notifyScrollEvent(g.win[0])
        }
            ...
            g.doc.translate.y = e,
            g.doc.translate.ty = -1 * e + "px",
            g.doc.css(b.trstyle, "translate(" + g.doc.translate.tx + "," + g.doc.translate.ty + ")"),
            t || g.notifyScrollEvent(g.win[0])
        }
        ,
        this.setScrollLeft = function(e, t) {
        ...
        this.updateScrollBar = function(e) {
            ...
            g.ishwscroll ? (g.rail.css({
                height: g.win.innerHeight() - (y.railpadding.top + y.railpadding.bottom)
            }),
            g.railh && g.railh.css({
                width: g.win.innerWidth() - (y.railpadding.left + y.railpadding.right)
            })) : ((i = {
                top: (n = g.getOffset()).top,
                left: n.left - (y.railpadding.left + y.railpadding.right)
            ...
            (t = y.railoffset) && (t.top && (i.top += t.top),
            t.left) && (i.left += t.left),
            g.railslocked || g.rail.css({
                top: i.top,
                left: i.left,
                height: (e ? e.h : g.win.innerHeight()) - (y.railpadding.top + y.railpadding.bottom)
            }),
            g.zoom && g.zoom.css({
                top: i.top + 1,
            ...
            (t = y.railhoffset) && (t.top && (i.top += t.top),
            t.left) && (i.left += t.left),
            ...
            g.railh.css({
                top: e - (y.railpadding.top + y.railpadding.bottom),
                left: n,
                width: g.railh.width
            })))
        }
        ...
        this.init = function() {
            ...
            b.isoperamini)
                return !0;
            if (b.isandroid && !("hidden"in P))
                return !0;
            y.emulatetouch = y.emulatetouch || y.touchbehavior,
            g.hasborderbox = j.getComputedStyle && "border-box" === j.getComputedStyle(P.body)["box-sizing"];
            var e, n = {
                "overflow-y": "hidden"
            };
            if ((b.isie11 || b.isie10) && (n["-ms-overflow-style"] = "none"),
            g.ishwscroll && (this.doc.css(b.transitionstyle, b.prefixstyle + "transform 0ms ease-out"),
            b.transitionend) && g.bind(g.doc, b.transitionend, g.onScrollTransitionEnd, !1),
            g.zindex = "auto",
            g.ispage || "auto" != y.zindex ? g.zindex = y.zindex : g.zindex = function() {
                var e = g.win;
                if ("zIndex"in e)
                    return e.zIndex();
                for (; 0 < e.length; ) {
            ...
            g.isie && 0 === g.zindex && "auto" == y.zindex && (g.zindex = "auto"),
            !g.ispage || !b.isieold) {
                var t = g.docscroll
                  , i = (g.ispage && (t = g.haswrapper ? g.win : g.doc),
                g.css(t, n),
                g.ispage && (b.isie11 || b.isie) && g.css(N("html"), n),
                !b.isios || g.ispage || g.haswrapper || g.css(v, {
                ...
                for (a in l)
                    s = l[a],
                    (o = y.railpadding[s] || 0) && r.css("padding-" + s, o + "px");
                r.append(i),
                r.width = Math.max(parseFloat(y.cursorwidth), i.outerWidth()),
                r.css({
                    width: r.width + "px",
                    zIndex: g.zindex,
                ...
                r.visibility = !0,
                r.scrollable = !0,
                r.align = "left" == y.railalign ? 0 : 1,
                g.rail = r;
                var c, u, d, h, f, p, m;
                g.rail.drag = !1;
                !y.boxzoom || g.ispage || b.isieold || (u = P.createElement("div"),
                g.bind(u, "click", g.doZoom),
                g.bind(u, "mouseenter", function() {
                    g.zoom.css("opacity", y.cursoropacitymax)
                }),
                g.bind(u, "mouseleave", function() {
                    g.zoom.css("opacity", y.cursoropacitymin)
                }),
                g.zoom = N(u),
                g.zoom.css({
                    cursor: "pointer",
                ...
                y.dblclickzoom && g.bind(g.win, "dblclick", g.doZoom),
                b.cantouch && y.gesturezoom && (g.ongesturezoom = function(e) {
                ...
                b.isieold && i.css("overflow", "hidden"),
                i.addClass("nicescroll-cursors"),
                g.cursorh = i,
                (c = N(P.createElement("div"))).attr("id", g.id + "-hr"),
                c.addClass("nicescroll-rails nicescroll-rails-hr"),
                c.height = Math.max(parseFloat(y.cursorwidth), i.outerHeight()),
                c.css({
                    height: c.height + "px",
                    zIndex: g.zindex,
                    background: y.background
                ...
                y.disableoutline && (b.isie && g.win.attr("hideFocus", "true"),
                b.iswebkit) && g.win.css("outline", "none")),
                !1 === y.autohidemode ? (g.autohidedom = !1,
                g.rail.css({
                    opacity: y.cursoropacitymax
                }),
                g.railh && g.railh.css({
                    opacity: y.cursoropacitymax
                })) : !0 === y.autohidemode || "leave" === y.autohidemode ? (g.autohidedom = N().add(g.rail),
                b.isie8 && (g.autohidedom = g.autohidedom.add(g.cursor)),
                g.railh && (g.autohidedom = g.autohidedom.add(g.railh)),
                g.railh && b.isie8 && (g.autohidedom = g.autohidedom.add(g.cursorh))) : "scroll" == y.autohidemode ? (g.autohidedom = N().add(g.rail),
                g.railh && (g.autohidedom = g.autohidedom.add(g.railh))) : "cursor" == y.autohidemode ? (g.autohidedom = N().add(g.cursor),
                g.railh && (g.autohidedom = g.autohidedom.add(g.cursorh))) : "hidden" == y.autohidemode && (g.autohidedom = !1,
                g.hide(),
                g.railslocked = !1),
                (b.cantouch || g.istouchcapable || y.emulatetouch || b.hasmstouch) && (g.scrollmom = new B(g),
                g.ontouchstart = function(e) {
                    ...
                    !g.railslocked) {
                        ...
                        g.ispage || !y.directionlockdeadzone ? g.rail.drag.dl = "f" : (r = Y.width(),
                        n = Y.height(),
                        ...
                        y.emulatetouch && g.isiframe && b.isie && (r = g.win.position(),
                        ...
                        t && o) {
                            if (!/INPUT|SELECT|BUTTON|TEXTAREA/i.test(t.nodeName))
                                return b.hasmousecapture && t.setCapture(),
                                y.emulatetouch ? (t.onclick && !t._onclick && (t._onclick = t.onclick,
                ...
                g.ontouchend = function(e) {
                    ...
                    g.lastmouseup = !0,
                    g.hideCursor(),
                    b.hasmousecapture && P.releaseCapture(),
                    t) ? g.cancelEvent(e) : void 0
                }
                ,
                d = y.emulatetouch && g.isiframe && !b.hasmousecapture,
                h = .3 * y.directionlockdeadzone | 0,
                g.ontouchmove = function(e, t) {
                    if (!g.rail.drag)
                        return !0;
                    if (e.targetTouches && y.preventmultitouchscrolling && 1 < e.targetTouches.length)
                        return !0;
                    if (e.pointerType && ("mouse" === e.pointerType || e.pointerType === e.MSPOINTER_TYPE_MOUSE))
                        return !0;
                    if (2 != g.rail.drag.pt)
                    ...
                    var n = e.clientY + r
                      ...
                      , r = i - g.rail.drag.x
                      , o = g.rail.drag.st - t;
                    if (g.ishwscroll && y.bouncescroll)
                    ...
                    g.ishwscroll && y.bouncescroll ? s < 0 ? s = Math.round(s / 2) : s > g.page.maxw && (s = g.page.maxw + Math.round((s - g.page.maxw) / 2)) : (s < 0 && (i = s = 0),
                    ...
                    !g.hasmoving) {
                        ...
                        var a = Math.abs(t)
                          , t = Math.abs(r)
                          , r = y.directionlockdeadzone;
                        if (g.rail.drag.ck ? "v" == g.rail.drag.ck ? r < t && a <= h ? g.rail.drag = !1 : r < a && (g.rail.drag.dl = "v") : "h" == g.rail.drag.ck && (r < a && t <= h ? g.rail.drag = !1 : r < t && (g.rail.drag.dl = "h")) : r < a && r < t ? g.rail.drag.dl = "f" : r < a ? g.rail.drag.dl = h < t ? "f" : "v" : r < t && (g.rail.drag.dl = h < a ? "f" : "h"),
                        !g.rail.drag.dl)
                            return g.cancelEvent(e);
                ...
                g.ontouchstartCursor = function(e, t) {
                    if (!g.rail.drag || 3 == g.rail.drag.pt)
                        ...
                        t = g.getTarget(e),
                        !g.ispage && b.hasmousecapture && t.setCapture(),
                        g.isiframe && !b.hasmousecapture && (g.saved.csspointerevents = g.doc.css("pointer-events"),
                        g.css(g.doc, {
                            "pointer-events": "none"
                        }))),
                        g.cancelEvent(e)
                ...
                g.ontouchendCursor = function(e) {
                    if (g.rail.drag && (b.hasmousecapture && P.releaseCapture(),
                    g.isiframe && !b.hasmousecapture && g.doc.css("pointer-events", g.saved.csspointerevents),
                    3 == g.rail.drag.pt))
                ...
                g.ontouchmoveCursor = function(e) {
                    ...
                    if (g.rail.drag && 3 == g.rail.drag.pt)
                        ...
                        g.synched("touchmove", function() {
                            ...
                            g.rail.drag.hr ? g.doScrollLeft(Math.round(g.scroll.x * g.scrollratio.x), y.cursordragspeed) : g.doScrollTop(Math.round(g.scroll.y * g.scrollratio.y), y.cursordragspeed))
                        }),
                        g.cancelEvent(e)
                }
                ),
                ...
                g.onmouseup = function(e) {
                    if (g.rail.drag)
                        return 1 != g.rail.drag.pt || (b.hasmousecapture && P.releaseCapture(),
                        g.isiframe && !b.hasmousecapture && g.doc.css("pointer-events", g.saved.csspointerevents),
                        g.rail.drag = !1,
                        g.cursorfreezed = !1,
                ...
                g.onmousemove = function(e) {
                    var t;
                    if (g.rail.drag)
                        return 1 !== g.rail.drag.pt ? void 0 : b.ischrome && 0 === e.which ? g.onmouseup(e) : (g.cursorfreezed = !0,
                ...
                ,
                b.cantouch || y.emulatetouch ? (g.onpreventclick = function(e) {
                    if (g.preventclick)
                ...
                ,
                g.onclick = !b.isios && function(e) {
                    return !g.lastmouseup || (g.lastmouseup = !1,
                    g.cancelEvent(e))
                }
                ,
                y.grabcursorenabled && b.cursorgrabvalue && (g.css(g.ispage ? g.doc : g.win, {
                ...
                b.hasw3ctouch ? (g.css(g.ispage ? N("html") : g.win, {
                    "touch-action": "none"
                }),
                g.css(g.rail, {
                    "touch-action": "none"
                ...
                g.delegate(P, "pointermove", g.ontouchmove)) : b.hasmstouch ? (g.css(g.ispage ? N("html") : g.win, {
                ...
                y.sensitiverail && (g.bind(g.rail, "click", function(e) {
                    g.doRailClick(e, !1, !1)
                }),
                ...
                y.sensitiverail) && (g.bind(g.railh, "click", function(e) {
                    g.doRailClick(e, !1, !0)
                }),
                ...
                y.cursordragontouch && (this.istouchcapable || b.cantouch) && (g.bind(g.cursor, "touchstart", g.ontouchstartCursor),
                ...
                y.emulatetouch || b.isandroid || b.isios ? (g.bind(b.hasmousecapture ? g.win : P, "mouseup", g.ontouchend),
                g.onclick && g.bind(P, "click", g.onclick),
                y.cursordragontouch ? (g.bind(g.cursor, "mousedown", g.onmousedown),
                ...
                g.railh && g.bind(g.railh, "mousedown", function(e) {
                    e.preventDefault()
                }))) : (g.bind(b.hasmousecapture ? g.win : P, "mouseup", g.onmouseup),
                ...
                !g.ispage && y.enablescrollonselection && (g.bind(g.win[0], "mousedown", g.onselectionstart),
                ...
                y.enablemousewheel && (g.isiframe || g.mousewheel(b.isie && g.ispage ? P : g.win, g.onmousewheel),
                g.mousewheel(g.rail, g.onmousewheel),
                g.railh) && g.mousewheel(g.railh, g.onmousewheelhr),
                g.ispage || b.cantouch || /HTML|^BODY/.test(g.win[0].nodeName) || (g.win.attr("tabindex") || g.win.attr({
                    tabindex: ++O
                }),
                g.bind(g.win, "focus", function(e) {
                    D = g.getTarget(e).id || g.getTarget(e) || !1,
                    g.hasfocus = !0,
                ...
                g.bind(g.win, "mouseenter", function(e) {
                    M = g.getTarget(e).id || g.getTarget(e) || !1,
                    g.hasmousefocus = !0,
                    g.canshowonmouseevent && g.noticeCursor()
                }),
                ...
                g.onkeypress = function(e) {
                    ...
                    if (N(t).attr("contenteditable"))
                        return !0;
                    if (g.hasfocus || g.hasmousefocus && !D || g.ispage && !D && !M) {
                        t = e.keyCode;
                        ...
                        case 63275:
                            ...
                            break;
                        case 32:
                            y.spacebarenabled && (i ? g.doScrollBy(g.view.h) : g.doScrollBy(-g.view.h),
                            r = !0);
                            break;
                        case 27:
                ...
                ,
                y.enablekeyboard && g.bind(P, b.isopera && !b.isopera12 ? "keypress" : "keydown", g.onkeypress),
                ...
                !b.ischrome || g.ispage || g.haswrapper || (p = g.win.attr("style"),
                ...
                ,
                !y.enableobserver || (g.isie11 || !1 === R || (g.observerbody = new R(function(e) {
                    if (e.forEach(function(e) {
                        if ("attributes" == e.type)
                            return v.hasClass("modal-open") && v.hasClass("modal-dialog") && !N.contains(N(".modal-dialog")[0], g.doc[0]) ? g.hide() : g.show()
                    }),
                ...
                g.observerremover.observe(m.parentNode, {
                    ...
                    attributes: !1,
                    subtree: !1
                })) : (g.bind(m, b.isie && !b.isie9 ? "propertychange" : "DOMAttrModified", g.onAttributeChange),
                b.isie9 && m.attachEvent("onpropertychange", g.onAttributeChange),
                g.bind(m, "DOMNodeRemoved", function(e) {
                    e.target === m && g.remove()
                }))),
                !g.ispage && y.boxzoom && g.bind(j, "resize", g.resizeZoom),
            ...
            "IFRAME" == this.doc[0].nodeName && (e = function() {
                ...
                b.isios || !y.iframeautoresize || g.isiframe || (g.win.scrollTop(0),
                g.doc.height(""),
                e = Math.max(t.getElementsByTagName("html")[0].scrollHeight, t.body.scrollHeight),
                g.doc.height(e)),
                g.lazyResize(30),
                g.css(N(g.iframe.body), n),
                b.isios && g.haswrapper && g.css(N(t.body), {
                    "-webkit-transform": "translate3d(0,0,0)"
                }),
                "contentWindow"in this ? g.bind(this.contentWindow, "scroll", g.onscroll) : g.bind(t, "scroll", g.onscroll),
                y.enablemousewheel && g.mousewheel(t, g.onmousewheel),
                y.enablekeyboard && g.bind(t, b.isopera ? "keypress" : "keydown", g.onkeypress),
                b.cantouch ? (g.bind(t, "touchstart", g.ontouchstart),
                g.bind(t, "touchmove", g.ontouchmove)) : y.emulatetouch && (g.bind(t, "mousedown", g.ontouchstart),
                g.bind(t, "mousemove", function(e) {
                    return g.ontouchmove(e, !0)
                }),
                y.grabcursorenabled) && b.cursorgrabvalue && g.css(N(t.body), {
                    cursor: b.cursorgrabvalue
                }),
                g.bind(t, "mouseup", g.ontouchend),
                g.zoom && (y.dblclickzoom && g.bind(t, "dblclick", g.doZoom),
        ...
        this.hideCursor = function(e) {
            g.cursortimeout || g.rail && g.autohidedom && (g.hasmousefocus && "leave" === y.autohidemode || (g.cursortimeout = setTimeout(function() {
        ...
        this.onResize = function(e, t) {
            ...
            g.cursorheight = 0,
            g.setScrollTop(0),
            g.rail && (g.rail.scrollable = !1)) : (g.page.maxh -= y.railpadding.top + y.railpadding.bottom,
            g.rail.scrollable = !0),
            ...
            g.cursorwidth = 0,
            g.setScrollLeft(0),
            g.railh && (g.railh.scrollable = !1)) : (g.page.maxw -= y.railpadding.left + y.railpadding.right,
            g.railh && (g.railh.scrollable = y.horizrailenabled)),
            ...
            g.cursorheight = y.cursorfixedheight || Math.max(y.cursorminheight, g.cursorheight),
            g.cursorwidth = Math.min(g.view.w, Math.round(g.view.w * (g.view.w / g.page.w))),
            g.cursorwidth = y.cursorfixedheight || Math.max(y.cursorminheight, g.cursorwidth),
            g.scrollvaluemax = g.view.h - g.cursorheight - (y.railpadding.top + y.railpadding.bottom),
            ...
            g.scrollvaluemaxw = g.railh.width - g.cursorwidth - (y.railpadding.left + y.railpadding.right)),
        ...
        0), _ = (this.onscreenresize = function(e) {
            clearTimeout(m);
        ...
        this._unbind = function(e, t, n, i) {
            I[t] ? g.undelegate(e, t, n, i) : e.removeEventListener(t, n, i)
        }
        ,
        ...
        this.remove = function() {
            ...
            g.cursortimeout && clearTimeout(g.cursortimeout),
            g.delaylist)
                g.delaylist[e] && H(g.delaylist[e].h);
            g.doZoomOut(),
            g.unbindAll(),
        ...
        ;
        var x, T = 0, S = 0, k = 0, E = 1, C = !1;
        this.onmousewheel = function(e) {
            var t, n;
            return !g.wheelprevented && !g.locked && (g.railslocked ? (g.debounced("checkunlock", g.resize, 250),
            !1) : g.rail.drag ? g.cancelEvent(e) : ("auto" === y.oneaxismousemode && 0 !== e.deltaX && (y.oneaxismousemode = !1),
            y.oneaxismousemode && 0 === e.deltaX && !g.rail.scrollable ? !g.railh || !g.railh.scrollable || g.onmousewheelhr(e) : (n = W(),
            t = !1,
            y.preservenativescrolling && g.checkarea + 600 < n && (g.nativescrollingarea = g.isScrollable(e),
            t = !0),
            g.checkarea = n,
        ...
        this.onmousewheelhr = function(e) {
            var t, n;
            if (!g.wheelprevented)
                return !(!g.railslocked && g.railh.scrollable) || (g.rail.drag ? g.cancelEvent(e) : (t = W(),
                n = !1,
                y.preservenativescrolling && g.checkarea + 600 < t && (g.nativescrollingarea = g.isScrollable(e),
                n = !0),
                g.checkarea = t,
        ...
        this.getTransitionSpeed = function(e) {
            return 80 + e / 72 * y.scrollspeed | 0
        }
        ,
        y.smoothscroll ? g.ishwscroll && b.hastransition && y.usetransition && y.smoothscroll ? (x = "",
        this.resetTransition = function() {
            x = "",
            g.doc.css(b.prefixstyle + "transition-duration", "0ms")
        }
        ,
        this.prepareTransition = function(e, t) {
            ...
            e = t + "ms";
            return x !== e && (x = e,
            g.doc.css(b.prefixstyle + "transition-duration", e)),
            t
        }
        ,
        ...
        this.doScrollPos = function(e, t, n) {
            ...
            y.bouncescroll ? (t < 0 ? t = t / 2 | 0 : t > g.page.maxh && (t = g.page.maxh + (t - g.page.maxh) / 2 | 0),
            ...
            b.transitionend || (g.scrollendtrapped && clearTimeout(g.scrollendtrapped),
        ...
        this.onScrollTransitionEnd = function() {
            if (g.scrollendtrapped) {
                ...
                e != g.newscrolly || t != g.newscrollx)
                    return g.doScrollPos(t, e, y.snapbackspeed);
        ...
        this.doScrollPos = function(e, t, n) {
            ...
            var s = 0 | Math.sqrt(g.dst.x * g.dst.x + g.dst.y * g.dst.y)
              ...
              , o = (g.bzscroll = {},
            o ? 1 : .58)
              , a = (g.bzscroll.x = new h(r,g.newscrollx,s,0,0,o,1),
            g.bzscroll.y = new h(i,g.newscrolly,s,0,0,o,1),
            W(),
            function() {
                var e;
                ...
                e <= 1 ? g.timer = z(a) : (g.scrollrunning = !1,
                g.timer = 0,
                g.triggerScrollEnd()))
            }
            );
        ...
        this.doZoomIn = function(e) {
            if (!g.zoomactive) {
                ...
                b.isios4 && (g.zoomrestore.scrollTop = Y.scrollTop(),
                Y.scrollTop(0)),
                g.win.css({
        ...
        this.doZoomOut = function(e) {
            if (g.zoomactive)
                ...
                b.isios4 && Y.scrollTop(g.zoomrestore.scrollTop),
                g.rail.css({
                    "z-index": g.zindex
                }),
                g.zoom.css({
        ...
        this.resizeZoom = function() {
            ...
            g.win.css({
                width: Y.width() - g.zoomrestore.padding.w + "px",
                height: Y.height() - g.zoomrestore.padding.h + "px"
            }),
            g.onResize(),
        ...
        this.doMomentum = function(e) {
            var t, n, i, r, o = W(), e = e ? o + e : u.lasttime, s = u.nc.getScrollLeft(), a = u.nc.getScrollTop(), l = u.nc.page.maxh, c = u.nc.page.maxw, e = (u.speedx = 0 < c ? Math.min(60, u.speedx) : 0,
    ...
    ), i = l.prototype, c = ["show", "hide", "toggle", "onResize", "resize", "remove", "stop", "doScrollPos"], u = 0, d = c.length; u < d; u++)
        !function(e, t) {
            e[t] = function() {
                var e = arguments;
                return this.each(function() {
...
function(e, t) {
    ...
    function a(e, t) {
        for (var n in t)
            p(t, n) && (e[n] = t[n]);
        return p(t, "toString") && (e.toString = t.toString),
    ...
    function $(e, t) {
        var n, i = a({}, e);
        for (n in t)
            p(t, n) && (Y(e[n]) && Y(t[n]) ? (i[n] = {},
            a(i[n], e[n]),
            a(i[n], t[n])) : null != t[n] ? i[n] = t[n] : delete i[n]);
        for (n in e)
            p(e, n) && !p(t, n) && Y(e[n]) && (i[n] = a({}, i[n]));
        return i
    }
    function X(e) {
        null != e && this.set(e)
    ...
    function Z(e, t) {
        ...
        vt[t] = vt[t] || function(i) {
            for (var e, r = i.match(mt), t = 0, o = r.length; t < o; t++)
                yt[r[t]] ? r[t] = yt[r[t]] : r[t] = (e = r[t]).match(/\[[\s\S]/) ? e.replace(/^\[|\]$/g, "") : e.replace(/\\/g, "");
            return function(e) {
                for (var t = "", n = 0; n < o; n++)
                    t += h(r[n]) ? r[n].call(e, i) : r[n];
                return t
            }
        }(t),
    ...
    function se(e, t) {
        ...
        if (e.isValid()) {
            if ("string" == typeof t)
                if (/^\d+$/.test(t))
                    t = d(t);
                else if (!I(t = e.localeData().monthsParse(t)))
                    return;
    ...
    function he(e, t, n) {
        ...
        return o < 1 ? i = o + fe(r = e.year() - 1, t, n) : o > fe(e.year(), t, n) ? (i = o - fe(e.year(), t, n),
        r = e.year() + 1) : (r = e.year(),
        i = o),
        {
            week: i,
    ...
    function _e(e, t) {
        return (Gt = e && (e = o(t) ? b(e) : we(e, t)) ? e : Gt)._abbr
    }
    function we(e, t) {
        if (null === t)
            return delete L[e],
    ...
    function b(e) {
        ...
        for (var n, i, r, o, s = e, a = 0; a < s.length; ) {
            for (n = (o = ye(s[a]).split("-")).length,
            i = (i = ye(s[a + 1])) ? i.split("-") : null; 0 < n; ) {
                if (r = be(o.slice(0, n).join("-")))
                    return r;
                if (i && i.length >= n && B(o, i, !0) >= n - 1)
                    break;
                n--
            }
            a++
    ...
    function xe(e) {
        var t = e._a;
        return t && -2 === m(e).overflow && (t = t[E] < 0 || 11 < t[E] ? E : t[C] < 1 || t[C] > oe(t[k], t[E]) ? C : t[D] < 0 || 24 < t[D] || 24 === t[D] && (0 !== t[M] || 0 !== t[O] || 0 !== t[Pt]) ? D : t[M] < 0 || 59 < t[M] ? M : t[O] < 0 || 59 < t[O] ? O : t[Pt] < 0 || 999 < t[Pt] ? Pt : -1,
        m(e)._overflowDayOfYear && (t < k || C < t) && (t = C),
        m(e)._overflowWeeks && -1 === t && (t = jt),
        m(e)._overflowWeekday && -1 === t && (t = Yt),
        m(e).overflow = t),
        e
    }
    function Te(e, t, n) {
    ...
    function Se(e) {
        var t, n, i, r, o, s, a, l, c, u, d, h = [];
        if (!e._d) {
            for (u = e,
            d = new Date(f.now()),
            n = u._useUTC ? [d.getUTCFullYear(), d.getUTCMonth(), d.getUTCDate()] : [d.getFullYear(), d.getMonth(), d.getDate()],
            e._w && null == e._a[C] && null == e._a[E] && (null != (d = (u = e)._w).GG || null != d.W || null != d.E ? (o = 1,
            s = 4,
            l = Te(d.GG, u._a[k], he(_(), 1, 4).year),
            c = Te(d.W, 1),
            ((i = Te(d.E, 1)) < 1 || 7 < i) && (r = !0)) : (o = u._locale._week.dow,
            s = u._locale._week.doy,
            a = he(_(), o, s),
            l = Te(d.gg, u._a[k], a.year),
            c = Te(d.w, a.week),
            null != d.d ? ((i = d.d) < 0 || 6 < i) && (r = !0) : null != d.e ? (i = d.e + o,
            (d.e < 0 || 6 < d.e) && (r = !0)) : i = o),
            c < 1 || c > fe(l, o, s) ? m(u)._overflowWeeks = !0 : null != r ? m(u)._overflowWeekday = !0 : (a = de(l, c, i, o, s),
            u._a[k] = a.year,
            u._dayOfYear = a.dayOfYear)),
            null != e._dayOfYear && (d = Te(e._a[k], n[k]),
            (e._dayOfYear > ee(d) || 0 === e._dayOfYear) && (m(e)._overflowDayOfYear = !0),
            r = ce(d, 0, e._dayOfYear),
            e._a[E] = r.getUTCMonth(),
            e._a[C] = r.getUTCDate()),
            t = 0; t < 3 && null == e._a[t]; ++t)
                e._a[t] = h[t] = n[t];
            for (; t < 7; t++)
                e._a[t] = h[t] = null == e._a[t] ? 2 === t ? 1 : 0 : e._a[t];
            24 === e._a[D] && 0 === e._a[M] && 0 === e._a[O] && 0 === e._a[Pt] && (e._nextDay = !0,
            e._a[D] = 0),
    ...
    function Ee(e) {
        ...
        r = n,
        o = e,
        i && Bt.indexOf(i) !== new Date(r[0],r[1],r[2]).getDay() ? (m(o).weekdayMismatch = !0,
        o._isValid = !1) : (e._a = n,
        e._tzm = (s = a[8],
        t = a[9],
        i = a[10],
        ...
        if (e._f !== f.ISO_8601)
            if (e._f !== f.RFC_2822) {
                ...
                for (var t, n = "" + e._i, i = n.length, r = 0, o = Q(e._f, e._locale).match(mt) || [], s = 0; s < o.length; s++)
                    t = o[s],
                    (h = (n.match((h = e,
                    p(Lt, d = t) ? Lt[d](h._strict, h._locale) : new RegExp(K(d.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function(e, t, n, i, r) {
                        return t || n || i || r
                    }))))) || [])[0]) && (0 < (d = n.substr(0, n.indexOf(h))).length && m(e).unusedInput.push(d),
                    n = n.slice(n.indexOf(h) + h.length),
                    r += h.length),
                    yt[t] ? (h ? m(e).empty = !1 : m(e).unusedTokens.push(t),
                    d = t,
                    u = e,
                    null != (c = h) && p(Nt, d) && Nt[d](c, u._a, u, d)) : e._strict && !h && m(e).unusedTokens.push(t);
                m(e).charsLeftOver = i - r,
                0 < n.length && m(e).unusedInput.push(n),
                e._a[D] <= 12 && !0 === m(e).bigHour && 0 < e._a[D] && (m(e).bigHour = void 0),
    ...
    function De(e) {
        ...
        return e._locale = e._locale || b(e._l),
        null === i || void 0 === r && "" === i ? W({
            nullInput: !0
        }) : ("string" == typeof i && (e._i = i = e._locale.preparse(i)),
        s(i) ? new F(xe(i)) : (z(i) ? e._d = i : l(r) ? function(e) {
            var t, n, i, r, o;
            if (0 === e._f.length)
            ...
            for (r = 0; r < e._f.length; r++)
                ...
                n = t);
            a(e, n || t)
        }(e) : r ? Ce(e) : o(r = (i = e)._i) ? i._d = new Date(f.now()) : z(r) ? i._d = new Date(r.valueOf()) : "string" == typeof r ? (t = i,
        null === (n = on.exec(t._i)) ? (ke(t),
        !1 === t._isValid && (delete t._isValid,
        Ee(t),
        !1 === t._isValid) && (delete t._isValid,
        f.createFromInputFallback(t))) : t._d = new Date(+n[1])) : l(r) ? (i._a = H(r.slice(0), function(e) {
            return parseInt(e, 10)
        }),
        Se(i)) : Y(r) ? (t = i)._d || (n = G(t._i),
        t._a = H([n.year, n.month, n.day || n.date, n.hour, n.minute, n.second, n.millisecond], function(e) {
            return e && parseInt(e, 10)
        }),
        Se(t)) : I(r) ? i._d = new Date(r) : f.createFromInputFallback(i),
        R(e) || (e._d = null),
        e))
    }
    function Me(e, t, n, i, r) {
        ...
        o._f = t,
        o._strict = i,
        (r = new F(xe(De(o))))._nextDay && (r.add(1, "d"),
        r._nextDay = void 0),
        r
    }
    function _(e, t, n, i) {
    ...
    function Ae(e) {
        ...
        this._isValid = function(e) {
            for (var t in e)
                if (-1 === A.call(ln, t) || null != e[t] && isNaN(e[t]))
                    return !1;
            for (var n = !1, i = 0; i < ln.length; ++i)
                if (e[ln[i]]) {
                    if (n)
                        return !1;
                    parseFloat(e[ln[i]]) !== d(e[ln[i]]) && (n = !0)
                }
            return !0
        }(e),
    ...
    function Pe(e, n) {
        i(e, 0, 0, function() {
            ...
            return e < 0 && (e = -e,
            t = "-"),
            t + v(~~(e / 60), 2) + n + v(~~e % 60, 2)
        })
    }
    function je(e, t) {
        var t = (t || "").match(e);
        return null === t ? null : 0 === (t = 60 * (e = ((t[t.length - 1] || []) + "").match(cn) || ["-", 0, 0])[1] + d(e[2])) ? 0 : "+" === e[0] ? t : -t
    }
    function Ye(e, t) {
        var n;
        return t._isUTC ? (t = t.clone(),
        n = (s(e) || z(e) ? e : _(e)).valueOf() - t.valueOf(),
    ...
    function w(e, t) {
        ...
        r = {
            ...
            m: He(t[7], n),
            s: He(t[8], n)
        }) : null == r ? r = {} : "object" == typeof r && ("from"in r || "to"in r) && (t = _(r.from),
        n = _(r.to),
        t = t.isValid() && n.isValid() ? (n = Ye(n, t),
        ...
        r.M = t.months),
        i = new Ae(r),
        Le(e) && p(e, "_locale") && (i._locale = e._locale),
        i
    }
    function He(e, t) {
    ...
    function We(i, r) {
        return function(e, t) {
            var n;
            return null === t || isNaN(+t) || (V(r, "moment()." + r + "(period, number) is deprecated. Please use moment()." + r + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."),
            n = e,
            e = t,
            t = n),
            qe(this, w(e = "string" == typeof e ? +e : e, t), i),
            this
        }
    }
    function qe(e, t, n, i) {
    ...
    function Be(e) {
        return void 0 === e ? this._locale._abbr : (null != (e = b(e)) && (this._locale = e),
        this)
    }
    function Ue() {
        return this._locale
    ...
    function $e(e, t, n, i, r) {
        var o;
        return null == e ? he(this, i, r).year : (o = fe(e, i, r),
        function(e, t, n, i, r) {
            e = de(e, t, n, i, r),
    ...
    , ut = f.momentProperties = [], dt = !1, ht = {}, ft = (f.suppressDeprecationWarnings = !1,
    ...
    ,
    {}), pt = {}, mt = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, gt = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, vt = {}, yt = {}, x = /\d/, T = /\d\d/, bt = /\d{3}/, _t = /\d{4}/, wt = /[+-]?\d{6}/, S = /\d\d?/, xt = /\d\d\d\d?/, Tt = /\d\d\d\d\d\d?/, St = /\d{1,3}/, kt = /\d{1,4}/, Et = /[+-]?\d{1,6}/, Ct = /\d+/, Dt = /[+-]?\d+/, Mt = /Z|[+-]\d\d:?\d\d/gi, Ot = /Z|[+-]\d\d(?::?\d\d)?/gi, At = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, Lt = {}, Nt = {}, k = 0, E = 1, C = 2, D = 3, M = 4, O = 5, Pt = 6, jt = 7, Yt = 8;
    i("Y", 0, 0, function() {
        var e = this.year();
        return e <= 9999 ? "" + e : "+" + e
    }),
    ...
    y(["YYYYY", "YYYYYY"], k),
    y("YYYY", function(e, t) {
        t[k] = 2 === e.length ? f.parseTwoDigitYear(e) : d(e)
    }),
    y("YY", function(e, t) {
    ...
    y(["MMM", "MMMM"], function(e, t, n, i) {
        ...
        null != i ? t[E] = i : m(n).invalidMonth = e
    }),
    /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/)
    ...
    i("hmm", 0, 0, function() {
        return "" + me.apply(this) + v(this.minutes(), 2)
    }),
    i("hmmss", 0, 0, function() {
        return "" + me.apply(this) + v(this.minutes(), 2) + v(this.seconds(), 2)
    }),
    i("Hmm", 0, 0, function() {
    ...
    var Gt, Zt, At = ne("Hours", !0), Qt = {
        ...
        PDT: -420,
        PST: -480
    }, xt = (f.createFromInputFallback = e("value provided is not in a recognized RFC2822 or ISO format. moment construction falls back to js Date(), which is not reliable across all browsers and versions. Non RFC2822/ISO date formats are discouraged and will be removed in an upcoming major release. Please refer to http://momentjs.com/guides/#/warnings/js-date/ for more info.", function(e) {
    ...
    })), Tt = e("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", function() {
        var e = _.apply(null, arguments);
    ...
    r("Z", Ot),
    r("ZZ", Ot),
    y(["Z", "ZZ"], function(e, t, n) {
        n._useUTC = !0,
        n._tzm = je(Ot, e)
    }),
    /([\+\-]|\d\d)/gi), un = (f.updateOffset = function() {}
    ,
    /^(\-|\+)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)(\.\d*)?)?$/), dn = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, Ht = (w.fn = Ae.prototype,
    w.invalid = function() {
        return w(NaN)
    }
    ,
    We(1, "add")), Ft = We(-1, "subtract"), Ut = (f.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ",
    ...
    ne("Date", !0)), _t = (i("DDD", ["DDDD", 3], "DDDo", "dayOfYear"),
    t("dayOfYear", "DDD"),
    n("dayOfYear", 4),
    r("DDD", St),
    r("DDDD", bt),
    y(["DDD", "DDDD"], function(e, t, n) {
        n._dayOfYear = d(e)
    }),
    i("m", ["mm", 2], 0, "minute"),
    t("minute", "m"),
    ...
    r("mm", S, T),
    y(["m", "mm"], M),
    ne("Minutes", !1)), Et = (i("s", ["ss", 2], 0, "second"),
    t("second", "s"),
    n("second", 15),
    r("s", S),
    r("ss", S, T),
    ...
    F.prototype)
      , T = (x.add = Ht,
    x.calendar = function(e, t) {
        var e = e || _()
          , n = Ye(e, this).startOf("day")
          , n = f.calendarFormat(this, n) || "sameElse"
          , t = t && (h(t[n]) ? t[n].call(this, e) : t[n]);
        return this.format(t || this.localeData().calendar(n, this, _(e)))
    }
    ,
    x.clone = function() {
        return new F(this)
    ...
    ,
    x.diff = function(e, t, n) {
        var i, r, o;
        if (!this.isValid())
            return NaN;
        if (!(i = Ye(e, this)).isValid())
            return NaN;
    ...
    ,
    x.from = function(e, t) {
        return this.isValid() && (s(e) && e.isValid() || _(e).isValid()) ? w({
            to: this,
            from: e
    ...
    ,
    x.get = function(e) {
        return h(this[e = g(e)]) ? this[e]() : this
    }
    ,
    ...
    x.set = function(n, e) {
        if ("object" == typeof n)
            for (var t = function() {
                ...
                t
            }(n = G(n)), i = 0; i < t.length; i++)
                this[t[i].unit](n[t[i].unit]);
        else if (h(this[n = g(n)]))
            return this[n](e);
        return this
    }
    ,
    ...
    ,
    x.quarter = x.quarters = function(e) {
    ...
    ,
    x.week = x.weeks = function(e) {
        var t = this.localeData().week(this);
        return null == e ? t : this.add(7 * (e - t), "d")
    }
    ,
    x.isoWeek = x.isoWeeks = function(e) {
    ...
    ,
    x.hour = x.hours = At,
    x.minute = x.minutes = _t,
    x.second = x.seconds = Et,
    x.millisecond = x.milliseconds = wt,
    x.utcOffset = function(e, t, n) {
        ...
        return !this._isUTC && t && (i = Ie(this)),
        this._offset = e,
        this._isUTC = !0,
        null != i && this.add(i, "m"),
        r !== e && (!t || this._changeInProgress ? qe(this, w(e - r, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
        f.updateOffset(this, !0),
    ...
    x.parseZone = function() {
        var e;
        return null != this._tzm ? this.utcOffset(this._tzm, !1, !0) : "string" == typeof this._i && (null != (e = je(Mt, this._i)) ? this.utcOffset(e) : this.utcOffset(0, !0)),
        this
    }
    ,
    x.hasAlignedHourOffset = function(e) {
        return !!this.isValid() && (e = e ? _(e).utcOffset() : 0,
    ...
    ,
    x.dates = e("dates accessor is deprecated. Use date instead.", kt),
    x.months = e("months accessor is deprecated. Use month instead", ae),
    x.years = e("years accessor is deprecated. Use year instead", It),
    x.zone = e("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", function(e, t) {
        return null != e ? (this.utcOffset(e = "string" != typeof e ? -e : e, t),
        this) : -this.utcOffset()
    }),
    x.isDSTShifted = e("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", function() {
        var e, t;
        return o(this._isDSTShifted) && (q(e = {}, this),
        (e = De(e))._a ? (t = (e._isUTC ? c : _)(e._a),
        this._isDSTShifted = this.isValid() && 0 < B(e._a, t.toArray())) : this._isDSTShifted = !1),
        this._isDSTShifted
    }),
    X.prototype)
      , N = (T.calendar = function(e, t, n) {
    ...
    T.preparse = Ge,
    T.postformat = Ge,
    T.relativeTime = function(e, t, n, i) {
    ...
    T.months = function(e, t) {
        return e ? (l(this._months) ? this._months : this._months[(this._months.isFormat || zt).test(t) ? "format" : "standalone"])[e.month()] : l(this._months) ? this._months : this._months.standalone
    }
    ,
    T.monthsShort = function(e, t) {
        return e ? (l(this._monthsShort) ? this._monthsShort : this._monthsShort[zt.test(t) ? "format" : "standalone"])[e.month()] : l(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone
    }
    ,
    T.monthsParse = function(e, t, n) {
        ...
        if (this._monthsParseExact)
            return function(e, t, n) {
                ...
                return n ? "MMM" === t ? -1 !== (r = A.call(this._shortMonthsParse, e)) ? r : null : -1 !== (r = A.call(this._longMonthsParse, e)) ? r : null : "MMM" === t ? -1 !== (r = A.call(this._shortMonthsParse, e)) || -1 !== (r = A.call(this._longMonthsParse, e)) ? r : null : -1 !== (r = A.call(this._longMonthsParse, e)) || -1 !== (r = A.call(this._shortMonthsParse, e)) ? r : null
            }
            .call(this, e, t, n);
    ...
    T.monthsRegex = function(e) {
        return this._monthsParseExact ? (p(this, "_monthsRegex") || le.call(this),
        e ? this._monthsStrictRegex : this._monthsRegex) : (p(this, "_monthsRegex") || (this._monthsRegex = qt),
        this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex)
    }
    ,
    T.monthsShortRegex = function(e) {
        return this._monthsParseExact ? (p(this, "_monthsRegex") || le.call(this),
        e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (p(this, "_monthsShortRegex") || (this._monthsShortRegex = Wt),
    ...
    T.weekdaysRegex = function(e) {
        return this._weekdaysParseExact ? (p(this, "_weekdaysRegex") || pe.call(this),
        e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (p(this, "_weekdaysRegex") || (this._weekdaysRegex = Vt),
        this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex)
    }
    ,
    T.weekdaysShortRegex = function(e) {
        return this._weekdaysParseExact ? (p(this, "_weekdaysRegex") || pe.call(this),
        e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (p(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = $t),
        this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
    }
    ,
    T.weekdaysMinRegex = function(e) {
        return this._weekdaysParseExact ? (p(this, "_weekdaysRegex") || pe.call(this),
        e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (p(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Xt),
    ...
    f.lang = e("moment.lang is deprecated. Use moment.locale instead.", _e),
    f.langData = e("moment.langData is deprecated. Use moment.localeData instead.", b),
    Math.abs)
      , St = it("ms")
      , bt = it("s")
      , Ht = it("m")
    ...
    f.updateLocale = function(e, t) {
        var n, i;
        return null != t ? (i = Qt,
        (n = new X(t = $(i = null != (n = be(e)) ? n._config : i, t))).parentLocale = L[e],
        L[e] = n,
        _e(e)) : null != L[e] && (null != L[e].parentLocale ? L[e] = L[e].parentLocale : null != L[e] && delete L[e]),
        L[e]
    }
    ,
    f.locales = function() {
    ...
    f.relativeTimeRounding = function(e) {
        return void 0 === e ? pn : "function" == typeof e && (pn = e,
        !0)
    }
    ,
