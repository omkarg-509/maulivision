          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="<?=BASE_URL?>customers/index">Create Customers</a></li>
                <li><a class="nav-link" href="<?=BASE_URL?>customers/history">Customers Details</a></li>
              </ul>
            </li>
